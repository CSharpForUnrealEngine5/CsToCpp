...
public partial class UAnimationBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Retrieves the Variable Frame Stripping Settings for the given Animation Sequence</summary>
	public static void GetVariableFrameStrippingSettings(UAnimSequence AnimationSequence,UVariableFrameStrippingSettings VariableFrameStrippingSettings) {}
	///<summary>Sets the Variable Frame Stripping Settings for the given Animation Sequence</summary>
