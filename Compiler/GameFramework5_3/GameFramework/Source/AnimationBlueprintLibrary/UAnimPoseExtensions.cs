...
public partial class UAnimPoseExtensions : UBlueprintFunctionLibrary {
	...
	public static void GetBoneNames(FAnimPose Pose,TArray<FName> Bones) {}
	///<summary>Retrieves the transform for the provided bone name from a pose</summary>
	public static FTransform GetBonePose(FAnimPose Pose,FName BoneName,EAnimPoseSpaces Space/*=EAnimPoseSpaces.Local*/) { return default; }
	///<summary>Sets the transform for the provided bone name for a pose</summary>
	public static void SetBonePose(FAnimPose Pose,FTransform Transform,FName BoneName,EAnimPoseSpaces Space/*=EAnimPoseSpaces.Local*/) {}
	///<summary>Retrieves the reference pose transform for the provided bone name</summary>
	public static FTransform GetRefBonePose(FAnimPose Pose,FName BoneName,EAnimPoseSpaces Space/*=EAnimPoseSpaces.Local*/) { return default; }
	///<summary>Retrieves the relative transform between the two provided bone names</summary>
	public static FTransform GetRelativeTransform(FAnimPose Pose,FName FromBoneName,FName ToBoneName,EAnimPoseSpaces Space/*=EAnimPoseSpaces.Local*/) { return default; }
	///<summary>Retrieves the relative transform between reference and animated bone transform</summary>
	public static FTransform GetRelativeToRefPoseTransform(FAnimPose Pose,FName BoneName,EAnimPoseSpaces Space/*=EAnimPoseSpaces.Local*/) { return default; }
	///<summary>Retrieves the relative transform for the reference pose between the two provided bone names</summary>
	public static FTransform GetRefPoseRelativeTransform(FAnimPose Pose,FName FromBoneName,FName ToBoneName,EAnimPoseSpaces Space/*=EAnimPoseSpaces.Local*/) { return default; }
	///<summary>Returns an array of socket names contained by the pose</summary>
	public static void GetSocketNames(FAnimPose Pose,TArray<FName> Sockets) {}
	///<summary>Retrieves the transform for the provided socket name from a pose</summary>
	public static FTransform GetSocketPose(FAnimPose Pose,FName SocketName,EAnimPoseSpaces Space/*=EAnimPoseSpaces.Local*/) { return default; }
	...
	public static void GetCurveNames(FAnimPose Pose,TArray<FName> Curves) {}
	///<summary>Returns the weight of an evaluated curve - if found</summary>
	public static float GetCurveWeight(FAnimPose Pose,FName CurveName) { return default; }
}
