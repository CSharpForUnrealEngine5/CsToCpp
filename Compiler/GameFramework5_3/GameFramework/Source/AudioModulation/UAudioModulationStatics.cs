...
public partial class UAudioModulationStatics : UBlueprintFunctionLibrary {
	...
	///<summary>Creates a modulation generator based on an Attack/Decay Envelope.</summary>
	public static USoundModulationGeneratorADEnvelope CreateADEnvelopeGenerator(UObject WorldContextObject,FName Name,FSoundModulationADEnvelopeParams Params) { return default; }
	...
	///<summary>Deactivates all currently active Control Bus Mixes. This includes the Global Control Bus Mixes.</summary>
	public static void DeactivateAllBusMixes(UObject WorldContextObject) {}
