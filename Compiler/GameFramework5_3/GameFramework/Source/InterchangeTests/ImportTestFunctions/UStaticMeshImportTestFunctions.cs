...
public partial class UStaticMeshImportTestFunctions : UImportTestFunctionsBase {
	...
	///<summary>Check whether the bounding box size is greater than given value</summary>
	public static FInterchangeTestFunctionResult CheckBoundingBoxSizeGreaterThan(UStaticMesh Mesh,FVector3f GreaterThanSize) { return default; }
	///<summary>Check whether the bounding box size is less than given value</summary>
	public static FInterchangeTestFunctionResult CheckBoundingBoxSizeLessThan(UStaticMesh Mesh,FVector3f LessThanSize) { return default; }
	///<summary>Check whether the bounding box size is equal to given value</summary>
	public static FInterchangeTestFunctionResult CheckBoundingBoxSize(UStaticMesh Mesh,FVector3f ExpectedSize) { return default; }
}
