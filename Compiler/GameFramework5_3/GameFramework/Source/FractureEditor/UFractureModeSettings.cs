...
public partial class UFractureModeSettings : UDeveloperSettings {
	...
	///<summary>The default asset folder presented when using the &quot;New&quot; tool to create a Geometry Collection in Fracture Mode</summary>
	...
	///<summary>Method to use to determine the area of the contact for transforms that are connected in the connection graph used for simulation. Only used if &quot;Use As Connection Graph&quot; is enabled.</summary>
	public EConnectionContactMethod ProximityConnectionContactAreaMethod;
	///<summary>Method to use to determine the contact between two pieces, if the Contact Threshold is greater than 0, for the purpose of filtering out too-small contacts</summary>
