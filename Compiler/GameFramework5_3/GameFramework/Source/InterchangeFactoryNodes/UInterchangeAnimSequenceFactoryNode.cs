...
public partial class UInterchangeAnimSequenceFactoryNode : UInterchangeFactoryBaseNode {
	...
	///<summary>Get the custom attribute AddCurveMetadataToSkeleton, return false if the attribute is not set.</summary>
	public bool GetCustomAddCurveMetadataToSkeleton(bool AttributeValue) { return default; }
	///<summary>Set the custom attribute AddCurveMetadataToSkeleton. Return false if the attribute cannot be set.</summary>
	public bool SetCustomAddCurveMetadataToSkeleton(bool AttributeValue) { return default; }
	...
	public void GetSceneNodeAnimationPayloadKeys(TMap<string,FInterchangeAnimationPayLoadKey> OutSceneNodeAnimationPayloadKeys) {}
	///<summary>SetAnimationPayloadKeysForSceneNodeUids</summary>
	public void SetAnimationPayloadKeysForSceneNodeUids(TMap<string,string> SceneNodeAnimationPayloadKeyUids,TMap<string,byte> SceneNodeAnimationPayloadKeyTypes) {}
	///<summary>GetMorphTargetNodeAnimationPayloadKeys</summary>
	public void GetMorphTargetNodeAnimationPayloadKeys(TMap<string,FInterchangeAnimationPayLoadKey> OutMorphTargetNodeAnimationPayloads) {}
	///<summary>SetAnimationPayloadKeysForMorphTargetNodeUids</summary>
	public void SetAnimationPayloadKeysForMorphTargetNodeUids(TMap<string,string> MorphTargetAnimationPayloadKeyUids,TMap<string,byte> MorphTargetAnimationPayloadKeyTypes) {}
}
