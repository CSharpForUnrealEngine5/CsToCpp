...
public partial class UQuartzClockHandle : UObject {
	...
	///<summary>NotifyOnQuantizationBoundary</summary>
	public void NotifyOnQuantizationBoundary(UObject WorldContextObject,FQuartzQuantizationBoundary InQuantizationBoundary,FOnQuartzCommandEventBP InDelegate,float InMsOffset/*=0.0f*/) {}
	...
	///<summary>Returns the current progress until the next occurrence of the provided musical duration as a float value from 0 (previous beat) to 1 (next beat).</summary>
	public float GetBeatProgressPercent(EQuartzCommandQuantization QuantizationBoundary/*=EQuartzCommandQuantization.Beat*/,float PhaseOffset/*=0.0f*/,float MsOffset/*=0.0f*/) { return default; }
}
