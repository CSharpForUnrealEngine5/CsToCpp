...
public partial class UMovieSceneSequenceExtensions : UBlueprintFunctionLibrary {
	...
	public static FMovieSceneObjectBindingID GetBindingID(UMovieSceneSequence Sequence,FMovieSceneBindingProxy InBinding) { return default; }
	...
	///<summary>* Set playback range locked</summary>
	public static void SetPlaybackRangeLocked(UMovieSceneSequence Sequence,bool bInLocked) {}
	///<summary>* Is playback ranged locked</summary>
	public static bool IsPlaybackRangeLocked(UMovieSceneSequence Sequence) { return default; }
	///<summary>* Set marked frames locked</summary>
	public static void SetMarkedFramesLocked(UMovieSceneSequence Sequence,bool bInLocked) {}
	///<summary>* Are marked frames locked</summary>
	public static bool AreMarkedFramesLocked(UMovieSceneSequence Sequence) { return default; }
}
