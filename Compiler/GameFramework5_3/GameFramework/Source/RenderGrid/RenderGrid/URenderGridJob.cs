...
public partial class URenderGridJob : UObject {
	...
	///<summary>Gets the calculated start frame, if possible.</summary>
	public void GetStartFrame(bool bSuccess,int StartFrame) {}
	///<summary>Gets the calculated end frame, if possible.</summary>
	public void GetEndFrame(bool bSuccess,int EndFrame) {}
	///<summary>Gets the calculated start time, if possible.</summary>
	public void GetStartTime(bool bSuccess,double StartTime) {}
	///<summary>Gets the calculated end time, if possible.</summary>
	public void GetEndTime(bool bSuccess,double EndTime) {}
	///<summary>Gets the calculated duration in seconds, if possible.</summary>
	public void GetDuration(bool bSuccess,double Duration) {}
	...
	public bool GetRemoteControlValue(FGuid FieldId,string Json) { return default; }
	...
	public bool GetRemoteControlFieldIdFromLabel(string Label,FGuid FieldId) { return default; }
	///<summary>GetRemoteControlLabelFromFieldId</summary>
	public bool GetRemoteControlLabelFromFieldId(FGuid FieldId,string Label) { return default; }
