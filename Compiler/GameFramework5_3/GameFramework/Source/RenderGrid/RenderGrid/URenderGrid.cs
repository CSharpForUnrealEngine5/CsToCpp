...
public partial class URenderGrid : UObject {
	...
	///<summary>Renders all the enabled jobs of this render grid. Only renders a single frame of each job.</summary>
	public URenderGridQueue RenderSingleFrame(int Frame) { return default; }
	///<summary>Renders the given job of this render grid. Only renders a single frame.</summary>
	public URenderGridQueue RenderJobSingleFrame(URenderGridJob Job,int Frame) { return default; }
	///<summary>Renders all the given jobs of this render grid. Only renders a single frame of each job.</summary>
	public URenderGridQueue RenderJobsSingleFrame(TArray<URenderGridJob> Jobs,int Frame) { return default; }
	///<summary>Renders all the enabled jobs of this render grid. Only renders a single frame of each job. The frame number it renders is based on the given FramePosition (0.0 is the first frame, 1.0 is the last frame, 0.5 is the frame in the middle, etc).</summary>
	public URenderGridQueue RenderSingleFramePosition(double FramePosition) { return default; }
	///<summary>Renders the given job of this render grid. Only renders a single frame. The frame number it renders is based on the given FramePosition (0.0 is the first frame, 1.0 is the last frame, 0.5 is the frame in the middle, etc).</summary>
	public URenderGridQueue RenderJobSingleFramePosition(URenderGridJob Job,double FramePosition) { return default; }
	///<summary>Renders all the given jobs of this render grid. Only renders a single frame of each job. The frame number it renders is based on the given FramePosition (0.0 is the first frame, 1.0 is the last frame, 0.5 is the frame in the middle, etc).</summary>
	public URenderGridQueue RenderJobsSingleFramePosition(TArray<URenderGridJob> Jobs,double FramePosition) { return default; }
	...
	public TSoftObjectPtr<UWorld> GetLevel() { return default; }
