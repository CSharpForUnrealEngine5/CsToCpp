...
public partial class UKismetMathLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Create a rotation from an axis and supplied angle (in degrees)</summary>
	...
	///<summary>Converts this color value to a hexadecimal string. The format of the string is RRGGBBAA.</summary>
	public static string ToHex_LinearColor(FLinearColor InColor) { return default; }
	...
	///<summary>Returns this date as the number of seconds since the Unix Epoch (January 1st of 1970).</summary>
	public static long ToUnixTimestamp(FDateTime Time) { return default; }
	///<summary>Returns this date as the number of seconds since the Unix Epoch (January 1st of 1970).</summary>
	public static double ToUnixTimestampDouble(FDateTime Time) { return default; }
	///<summary>Returns the date from Unix time (seconds from midnight 1970-01-01)</summary>
	public static FDateTime FromUnixTimestamp(long UnixTime) { return default; }
