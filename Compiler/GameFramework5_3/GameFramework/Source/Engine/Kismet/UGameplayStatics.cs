...
public partial class UGameplayStatics : UBlueprintFunctionLibrary {
	...
	///<summary>Determines if any local player controller&#39;s camera is within range of the specified location.</summary>
	public static bool IsAnyLocalPlayerCameraWithinRange(UObject WorldContextObject,FVector Location,float MaximumRange) { return default; }
	...
	///<summary>Returns a launch velocity need for a projectile to hit the TargetActor in TimeToTarget seconds based on the TargetActor&#39;s current velocity.</summary>
	public static bool SuggestProjectileVelocity_MovingTarget(UObject WorldContextObject,FVector OutLaunchVelocity,FVector ProjectileStartLocation,AActor TargetActor,FVector TargetLocationOffset/*=FVector.ZeroVector*/,double GravityZOverride/*=0.0f*/,double TimeToTarget/*=1.0f*/,EDrawDebugTrace DrawDebugType/*=EDrawDebugTrace.Type.None*/,float DrawDebugTime/*=3.0f*/,FLinearColor DrawDebugColor/*=FLinearColor.Red*/) { return default; }
