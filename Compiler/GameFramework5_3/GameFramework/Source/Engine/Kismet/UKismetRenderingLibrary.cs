...
public partial class UKismetRenderingLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Enables or disables the path tracer for the current Game Viewport.</summary>
	public static void EnablePathTracing(bool bEnablePathTracer) {}
	///<summary>Forces the path tracer to restart sample accumulation.</summary>
