...
public partial class UCommandlet : UObject {
	...
	///<summary>Whether to use the commandlet result as the exit code, even if errors were logged during the whole engine execution</summary>
	public bool UseCommandletResultAsExitCode;
}
