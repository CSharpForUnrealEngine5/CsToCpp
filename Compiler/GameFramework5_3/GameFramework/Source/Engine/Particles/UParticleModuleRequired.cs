...
public partial class UParticleModuleRequired : UParticleModule {
	...
	///<summary>bOverrideUseVelocityForMotionBlur</summary>
	public bool bOverrideUseVelocityForMotionBlur;
	///<summary>When supported by the vertex factory will use particle velocity for motion blur approximation.</summary>
