...
public partial class UInstancedStaticMeshComponent : UStaticMeshComponent {
	...
	///<summary>Update number of custom data entries per instance. This applies to all instances and will reallocate the full custom data buffer and reset all values to 0</summary>
	...
	///<summary>Gets the fading start and culling end distances for this component.</summary>
	public void GetCullDistances(int OutStartCullDistance,int OutEndCullDistance) {}
