...
public partial class UHierarchicalInstancedStaticMeshComponent : UInstancedStaticMeshComponent {
	...
	///<summary>Scale applied to change the computation of LOD distances when using the StaticMesh screen sizes.</summary>
	...
	///<summary>GetLODDistanceScale</summary>
	public float GetLODDistanceScale() { return default; }
}
