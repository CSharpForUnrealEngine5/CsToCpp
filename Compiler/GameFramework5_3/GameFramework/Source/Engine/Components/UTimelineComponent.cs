...
public partial class UTimelineComponent : UActorComponent {
	...
	///<summary>Add a callback event to the timeline</summary>
	public void AddEvent(float Time,FOnTimelineEvent EventFunc) {}
	///<summary>Add a vector interpolation to the timeline</summary>
	public void AddInterpVector(UCurveVector VectorCurve,FOnTimelineVector InterpFunc,FName PropertyName/*=NAME_None*/,FName TrackName/*=NAME_None*/) {}
	///<summary>Add a float interpolation to the timeline</summary>
	public void AddInterpFloat(UCurveFloat FloatCurve,FOnTimelineFloat InterpFunc,FName PropertyName/*=NAME_None*/,FName TrackName/*=NAME_None*/) {}
	///<summary>Add a linear color interpolation to the timeline</summary>
	public void AddInterpLinearColor(UCurveLinearColor LinearColorCurve,FOnTimelineLinearColor InterpFunc,FName PropertyName/*=NAME_None*/,FName TrackName/*=NAME_None*/) {}
	///<summary>Set the delegate to call after each timeline tick</summary>
	public void SetTimelinePostUpdateFunc(FOnTimelineEvent NewTimelinePostUpdateFunc) {}
	///<summary>Set the delegate to call when timeline is finished</summary>
	public void SetTimelineFinishedFunc(FOnTimelineEvent NewTimelineFinishedFunc) {}
}
