...
public partial class UChildActorComponent : USceneComponent {
	...
	///<summary>Should the spawned actor be marked as transient?</summary>
	public bool bChildActorIsTransient;
	///<summary>OnRep_ChildActor</summary>
	public void OnRep_ChildActor() {}
	///<summary>OnChildActorDestroyed</summary>
	public void OnChildActorDestroyed(AActor Actor) {}
}
