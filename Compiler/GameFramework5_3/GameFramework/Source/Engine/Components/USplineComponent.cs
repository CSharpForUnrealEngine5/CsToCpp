...
public partial class USplineComponent : UPrimitiveComponent {
	...
	///<summary>Get distance along the spline at closest point of the provided input location</summary>
	public float GetDistanceAlongSplineAtLocation(FVector InLocation,ESplineCoordinateSpace CoordinateSpace) { return default; }
	...
	///<summary>Get the input key (e.g. the time) of the control point of the spline at the specified index.</summary>
	public float GetInputKeyValueAtSplinePoint(int PointIndex) { return default; }
	///<summary>Gets the spline point of the spline at the specified index</summary>
	public FSplinePoint GetSplinePointAt(int PointIndex,ESplineCoordinateSpace CoordinateSpace) { return default; }
