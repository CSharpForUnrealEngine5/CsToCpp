...
public partial class UDirectionalLightComponent : ULightComponent {
	...
	///<summary>0: no Far Shadow Cascades, otherwise the number of cascades between DynamicShadowDistance and FarShadowDistance that are covered by Far Shadow Cascades.</summary>
	...
	///<summary>Whether the light should cast any shadows from opaque meshes onto clouds. This is disabled when &#39;Atmosphere Sun Light Index&#39; is set to 1.</summary>
