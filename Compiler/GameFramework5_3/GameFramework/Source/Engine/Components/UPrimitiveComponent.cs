...
public partial class UPrimitiveComponent : USceneComponent {
	...
	///<summary>Whether or not the bounds of this component should be considered when focusing the editor camera to an actor with this component in it.</summary>
	public virtual bool GetIgnoreBoundsForEditorFocus() { return default; }
	///<summary>Set if we should ignore bounds when focusing the editor camera.</summary>
