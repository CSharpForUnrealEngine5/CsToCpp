...
public partial class USkinnedMeshComponent : UMeshComponent {
	...
	///<summary>Get world-space bone transform.</summary>
	public FTransform GetBoneTransform(FName InBoneName,ERelativeTransformSpace TransformSpace/*=RTS_World*/) { return default; }
