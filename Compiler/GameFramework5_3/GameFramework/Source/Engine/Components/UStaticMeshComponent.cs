...
public partial class UStaticMeshComponent : UMeshComponent {
	...
	///<summary>Forces this component to always use Nanite for masked materials, even if FNaniteSettings::bAllowMaskedMaterials=false</summary>
	...
	///<summary>Whether world position offset turns on velocity writes.</summary>
	...
	///<summary>SetWorldPositionOffsetDisableDistance</summary>
