...
public partial class UCameraComponent : USceneComponent {
	...
	///<summary>Override for the default aspect ratio axis constraint defined on the local player</summary>
	public EAspectRatioAxisConstraint AspectRatioAxisConstraint;
	///<summary>SetAspectRatioAxisConstraint</summary>
	public void SetAspectRatioAxisConstraint(EAspectRatioAxisConstraint InAspectRatioAxisConstraint) {}
	...
	///<summary>Whether to override the default aspect ratio axis constraint defined on the local player</summary>
	...
	public virtual FText GetFilmbackText() { return default; }
