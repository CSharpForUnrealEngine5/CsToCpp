...
public partial class UPhysicsSettings : UPhysicsSettingsCore {
	...
	///<summary>Settings for Networked Physics Prediction, experimental.</summary>
	...
	///<summary>GetPhysicsHistoryCount</summary>
	public int GetPhysicsHistoryCount() { return default; }
}
