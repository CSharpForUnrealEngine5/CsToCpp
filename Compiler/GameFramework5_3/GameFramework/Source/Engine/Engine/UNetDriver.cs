...
public partial class UNetDriver : UObject {
	...
	///<summary>Can be used to configure settings for the ReplicationSystem</summary>
	public FNetDriverReplicationSystemConfig ReplicationSystemConfig;
	///<summary>@todo document</summary>
	public int MaxDownloadSize;
	///<summary>@todo document</summary>
	public bool bClampListenServerTickRate;
	///<summary>NetServerMaxTickRate</summary>
