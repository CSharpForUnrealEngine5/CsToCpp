...
public partial class UEngine : UObject {
	...
	///<summary>A material used to render the debug texture painting mask on mesh.</summary>
	...
	///<summary>Stable glint BSDF texture</summary>
	public UTexture2DArray GlintTexture;
	///<summary>Stable glint BSDF texture with more variety to cover slope space and avoid circular artifact</summary>
	public UTexture2DArray GlintTexture2;
	///<summary>Path of the glint BSDF texture</summary>
	public FSoftObjectPath GlintTextureName;
	///<summary>Path of the glint BSDF texture 2</summary>
	public FSoftObjectPath GlintTexture2Name;
	///<summary>Simple volume LUT texture</summary>
	public UVolumeTexture SimpleVolumeTexture;
	///<summary>Path of the simple volume LUT texture</summary>
	public FSoftObjectPath SimpleVolumeTextureName;
	///<summary>Simple volume environment LUT texture</summary>
	public UVolumeTexture SimpleVolumeEnvTexture;
	///<summary>Path of the simple volume environment LUT texture</summary>
