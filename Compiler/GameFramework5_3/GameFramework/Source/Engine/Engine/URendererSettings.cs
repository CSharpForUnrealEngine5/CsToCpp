...
public partial class URendererSettings : UDeveloperSettings {
	...
	///<summary>Whether to allow Deferred Shading on OpenGL, requires the DXC shader compiler and Mobile Shading set to deferred</summary>
	...
	///<summary>ShaderCompressionFormat_DEPRECATED</summary>
	public EShaderCompressionFormat ShaderCompressionFormat_DEPRECATED;
	...
	///<summary>bEnableRayTracingSkylight_DEPRECATED</summary>
	public bool bEnableRayTracingSkylight_DEPRECATED;
	...
	///<summary>Set the level of foveation to apply when generating the Variable Rate Shading attachment. This feature is currently experimental.</summary>
	public EFixedFoveationLevels FoveationLevel;
	///<summary>Allows foveation level to adjust dynamically based on GPU utilization.</summary>
	...
	///<summary>Default Value for Local Exposure Highlight Contrast Scale.</summary>
	public float DefaultFeatureLocalExposureHighlightContrastScale;
	///<summary>Default Value for Local Exposure Shadow Contrast Scale.</summary>
	...
	///<summary>DefaultManualScreenPercentage</summary>
	public float DefaultManualScreenPercentage;
	///<summary>DefaultScreenPercentageDesktopMode</summary>
	public EScreenPercentageMode DefaultScreenPercentageDesktopMode;
	///<summary>DefaultScreenPercentageMobileMode</summary>
	public EScreenPercentageMode DefaultScreenPercentageMobileMode;
	///<summary>DefaultScreenPercentageVRMode</summary>
	public EScreenPercentageMode DefaultScreenPercentageVRMode;
	///<summary>DefaultScreenPercentagePathTracerMode</summary>
	...
	///<summary>When enabled mesh LODs will stream in based on what is visible on screen.</summary>
	...
	///<summary>Enable Rough Diffuse Material. Please note that when Substrate is enabled, energy conservation is forced to ENABLED.</summary>
