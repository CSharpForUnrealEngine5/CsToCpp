...
public partial class UUserInterfaceSettings : UDeveloperSettings {
	...
	///<summary>Controls the relationship between UMG font size and pixel height.</summary>
	public uint CustomFontDPI;
	///<summary>Controls the relationship between UMG font size and pixel height.</summary>
	public EFontDPI FontDPIPreset;
	///<summary>To set your own custom value, check this box, then enter the value in the text box.</summary>
