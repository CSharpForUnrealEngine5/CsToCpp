...
public partial class UMaterialInterface : UObject {
	...
	///<summary>Specular Profile. For internal usage, not editable/visible</summary>
	public TArray<USpecularProfile> SpecularProfiles;
	///<summary>Whether this material interface is included in the base game (and not in a DLC)</summary>
	...
	///<summary>Get the associated nanite override material.</summary>
	public UMaterialInterface GetNaniteOverideMaterial() { return default; }
