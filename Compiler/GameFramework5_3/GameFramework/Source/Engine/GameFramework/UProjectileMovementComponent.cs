...
public partial class UProjectileMovementComponent : UMovementComponent {
	...
	///<summary>If true, throttle interpolation when not relevant.</summary>
	public bool bThrottleInterpolation;
	///<summary>If true, uses FScopedMovementUpdate to avoid moving the attached interpolated object&#39;s children more than once during a tick when it would both interpolate and move during projectile simulation.</summary>
	...
	///<summary>Time after not rendered recently when we consider throttling interpolation.</summary>
	public float ThrottleInterpolationThresholdNotRenderedShortTime;
	///<summary>Time after not rendered for a long time when we consider throttling interpolation.</summary>
	public float ThrottleInterpolationThresholdNotRenderedLongTime;
	///<summary>When recently relevant, skip this many frames of interpolation if throttling is enabled.</summary>
	public int ThrottleInterpolationSkipFramesRecent;
	///<summary>When not recently relevant, skip this many frames of interpolation if throttling is enabled.</summary>
