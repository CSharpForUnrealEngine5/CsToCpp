...
public partial class UCharacterMovementComponent : UPawnMovementComponent {
	...
	///<summary>A normalized vector representing the direction of gravity for gravity relative movement modes: walking, falling,</summary>
	public FVector GravityDirection;
	///<summary>A cached quaternion representing the rotation from world space to gravity relative space defined by GravityDirection.</summary>
	public FQuat WorldToGravityTransform;
	///<summary>A cached quaternion representing the inverse rotation from world space to gravity relative space defined by GravityDirection.</summary>
	...
	///<summary>True when the networked gravity direction has been replicated.</summary>
