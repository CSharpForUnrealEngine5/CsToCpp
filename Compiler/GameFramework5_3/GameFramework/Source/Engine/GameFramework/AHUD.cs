...
public partial class AHUD : AActor {
	...
	public virtual void ShowDebug(FName DebugType/*=NAME_None*/) {}
	...
	public void AddHitBox(FVector2D Position,FVector2D Size,FName InName,bool bConsumesInput,int Priority/*=0*/) {}
