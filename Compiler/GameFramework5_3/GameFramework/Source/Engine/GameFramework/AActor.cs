...
public partial class AActor : UObject {
	...
	///<summary>If checked, this Actor will only get loaded in a main world (persistent level), it will not be loaded through Level Instances.</summary>
	...
	///<summary>Which mode to replicate physics through for this actor. Only relevant if the actor replicates movement and has a component that simulate physics.</summary>
	public EPhysicsReplicationMode PhysicsReplicationMode;
	///<summary>Set the physics replication mode of this body, via EPhysicsReplicationMode</summary>
	public void SetPhysicsReplicationMode(EPhysicsReplicationMode ReplicationMode) {}
	///<summary>Get the physics replication mode of this body, via EPhysicsReplicationMode</summary>
	public EPhysicsReplicationMode GetPhysicsReplicationMode() { return default; }
	///<summary>Can this body trigger a resimulation when Physics Prediction is enabled</summary>
	public bool CanTriggerResimulation() { return default; }
	///<summary>Get the error threshold in centimeters before this object should enforce a resimulation to trigger.</summary>
	public float GetResimulationThreshold() { return default; }
	...
	///<summary>The GUID for this actor; this guid will be the same for actors from instanced streaming levels.</summary>
	public FGuid ActorGuid;
	///<summary>The instance GUID for this actor; this guid will be unique for actors from instanced streaming levels.</summary>
	...
	///<summary>Searches components array and returns first encountered component with a given tag.</summary>
	public UActorComponent FindComponentByTag(UClass ComponentClass,FName Tag) { return default; }
