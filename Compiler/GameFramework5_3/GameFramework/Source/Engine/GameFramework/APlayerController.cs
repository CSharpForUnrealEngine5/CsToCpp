...
public partial class APlayerController : AController {
	...
	public UClass AsyncPhysicsDataClass_DEPRECATED;
	///<summary>GetAsyncPhysicsDataToWrite</summary>
	public UAsyncPhysicsData GetAsyncPhysicsDataToWrite() { return default; }
	///<summary>GetAsyncPhysicsDataToConsume</summary>
	public UAsyncPhysicsData GetAsyncPhysicsDataToConsume() { return default; }
	///<summary>AsyncPhysicsDataComponent_DEPRECARED</summary>
	...
	///<summary>Whether the PlayerController should be used as a World Partiton streaming source.</summary>
	public virtual bool IsStreamingSourceEnabled() { return default; }
	///<summary>Whether the PlayerController streaming source should activate cells after loading.</summary>
	public virtual bool StreamingSourceShouldActivate() { return default; }
	///<summary>Whether the PlayerController streaming source should block on slow streaming.</summary>
	public virtual bool StreamingSourceShouldBlockOnSlowStreaming() { return default; }
	///<summary>Gets the streaming source priority.</summary>
	public virtual EStreamingSourcePriority GetStreamingSourcePriority() { return default; }
	///<summary>Gets the streaming source location and rotation.</summary>
	public virtual void GetStreamingSourceLocationAndRotation(FVector OutLocation,FRotator OutRotation) {}
	///<summary>Gets the streaming source priority.</summary>
	public virtual void GetStreamingSourceShapes(TArray<FStreamingSourceShape> OutShapes) {}
	///<summary>Fire the player&#39;s currently selected weapon with the optional firemode.</summary>
	public virtual void StartFire(byte FireModeNum/*=0*/) {}
	...
	public virtual bool CanRestartPlayer() { return default; }
	...
	public virtual FVector GetFocalLocation() { return default; }
