...
public partial class AWorldSettings : AInfo {
	...
	///<summary>if set to true, this hide the streaming disabled warning available in the viewport</summary>
	public bool bHideEnableStreamingWarning;
	...
	///<summary>Whether to configure the listening socket to allow reuse of the address and port. If this is true, be sure no other</summary>
	public bool bReuseAddressAndPort;
	...
	///<summary>NANITE SETTINGS *</summary>
	public FNaniteSettings NaniteSettings;
	///<summary>OnRep_NaniteSettings</summary>
	public virtual void OnRep_NaniteSettings() {}
