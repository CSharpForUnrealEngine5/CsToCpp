...
public partial class UAnimMontage : UAnimCompositeBase {
	...
	///<summary>Index of the slot track used for collecting sync markers</summary>
	...
	///<summary>Check if this slot has a valid additive animation for the specified slot.</summary>
	public bool IsValidAdditiveSlot(FName SlotNodeName) { return default; }
	...
	///<summary>Get the Montage&#39;s Group Name. This is the group from the first slot.</summary>
	public FName GetGroupName() { return default; }
