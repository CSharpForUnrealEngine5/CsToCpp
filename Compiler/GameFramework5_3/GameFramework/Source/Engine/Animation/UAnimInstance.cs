...
public partial class UAnimInstance : UObject {
	...
	///<summary>Return true if this instance has an active montage in the given slot. A UAnimMontage that is playing in the slot and blending out is not determined to be &quot;active&quot;.</summary>
	public bool IsSlotActive(FName SlotNodeName) { return default; }
	///<summary>Get local weight of any montages this slot node is playing. If this slot is not currently playing a montage, it will return 0.</summary>
	public float Blueprint_GetSlotMontageLocalWeight(FName SlotNodeName) { return default; }
	...
	///<summary>This returns all curve names. This is the same as calling GetActiveCurveNames with CurveType == AttributeCurve</summary>
