...
public partial class UInterchangeAnimationTrackNode : UInterchangeAnimationTrackBaseNode {
	...
	public bool SetCustomAnimationPayloadKey(string InUniqueId,EInterchangeAnimationPayLoadType InType) { return default; }
	///<summary>Get the payload key needed to retrieve the animation for this track.</summary>
	public bool GetCustomAnimationPayloadKey(FInterchangeAnimationPayLoadKey AnimationPayLoadKey) { return default; }
