...
public partial class UInterchangeSceneNode : UInterchangeBaseNode {
	...
	///<summary>Set MorphTarget with given weight.</summary>
	public bool SetMorphTargetCurveWeight(string MorphTargetName,float Weight) { return default; }
	///<summary>Get MorphTargets and their weights.</summary>
	public void GetMorphTargetCurveWeights(TMap<string,float> OutMorphTargetCurveWeights) {}
