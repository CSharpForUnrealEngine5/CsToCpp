...
public partial class UMirrorToolProperties : UInteractiveToolPropertySet {
	...
	///<summary>Whether to locally simplify new edges created when cropping along the mirror plane. Will only simplify when doing so will not change the shape, UVs or PolyGroups.</summary>
	public bool bSimplifyAlongCrop;
	...
	public EMirrorSaveMode WriteTo;
}
