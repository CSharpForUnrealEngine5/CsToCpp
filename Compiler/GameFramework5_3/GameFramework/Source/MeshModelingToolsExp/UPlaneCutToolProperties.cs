...
public partial class UPlaneCutToolProperties : UInteractiveToolPropertySet {
	...
	///<summary>If true, will simplify triangulation along plane cut when doing so will not affect the shape, UVs or PolyGroups</summary>
	public bool bSimplifyAlongCut;
}
