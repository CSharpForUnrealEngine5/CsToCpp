...
public partial class UVCamOutputProviderBase : UObject {
	...
	///<summary>Defines how the overlay widget should be added to the viewport. This should set as early as possible: in the constructor.</summary>
	...
	///<summary>We call UVPFullScreenUserWidget::SetCustomPostProcessSettingsSource(this), which will cause these settings to be discovered. They are later passed down to FEditorViewportViewModifierDelegate.</summary>
	public FPostProcessSettings PostProcessSettingsForWidget;
