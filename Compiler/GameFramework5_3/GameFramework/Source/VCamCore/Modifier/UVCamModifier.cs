...
public partial class UVCamModifier : UObject {
	...
	public bool SetStackEntryName(FName NewName) { return default; }
	///<summary>Gets the name of the modifier in the associated modifier stack</summary>
	public FName GetStackEntryName() { return default; }
	...
	public TMap<FName,FVCamModifierConnectionPoint> ConnectionPoints;
	///<summary>bNeedsInitialization</summary>
	public bool bNeedsInitialization;
}
