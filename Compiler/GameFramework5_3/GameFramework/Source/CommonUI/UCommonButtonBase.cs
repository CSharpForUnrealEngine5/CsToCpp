...
public partial class UCommonButtonBase : UCommonUserWidget {
	...
	public FWidgetEventField ClickEvent;
	...
	///<summary>If HoldData is valid, assigns its values to Keyboard and Mouse, Gamepad and Touch, based off the Current Input Type.</summary>
	public virtual void UpdateHoldData(ECommonInputType CurrentInputType) {}
	...
	///<summary>By default, if bRequiresHold is true, the bound Input Action will be forced to require hold as well.</summary>
	public virtual bool GetConvertInputActionToHold() { return default; }
	///<summary>Bound to the hold progress of the bound key from the input action</summary>
	public virtual void NativeOnActionProgress(float HeldPercent) {}
	///<summary>Bound to the hold progress not related to the bound key</summary>
	public virtual bool NativeOnHoldProgress(float DeltaTime) { return default; }
	///<summary>Bound to the hold progress rollback not related to the bound key</summary>
	public virtual bool NativeOnHoldProgressRollback(float DeltaTime) { return default; }
	...
	///<summary>HoldReset</summary>
	public virtual void HoldReset() {}
	...
	///<summary>True if this button should have a press and hold behavior, triggering the click when the specified hold time is met</summary>
	public bool bRequiresHold;
	///<summary>Press and Hold values used for Keyboard and Mouse, Gamepad and Touch, depending on the current input type</summary>
	public UClass HoldData;
	///<summary>True if this button should play the hover effect when pressed by a touch input</summary>
	public bool bSimulateHoverOnTouchInput;
	///<summary>The type of mouse action required by the user to trigger the button&#39;s &#39;Click&#39;</summary>
