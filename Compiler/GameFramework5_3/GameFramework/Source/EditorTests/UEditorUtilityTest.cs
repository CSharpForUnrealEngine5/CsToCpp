...
public partial class UEditorUtilityTest : UObject {
	...
	public virtual void FinishPrepareTest() {}
	...
	public virtual void FinishTest(EEditorUtilityTestResult TestState,string Message) {}
	...
	public virtual void ExpectTrue(bool Condition,string ErrorMessage) {}
	///<summary>Add error if expected condition is true</summary>
	public virtual void ExpectFalse(bool Condition,string ErrorMessage) {}
	///<summary>Get test state</summary>
	public virtual EEditorUtilityTestResult GetState() { return default; }
