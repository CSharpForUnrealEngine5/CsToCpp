...
public partial class UMaterialEditingLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Get the array of input pin names for a material expression</summary>
	public static TArray<string> GetMaterialExpressionInputNames(UMaterialExpression MaterialExpression) { return default; }
	///<summary>Get the array of input pin types for a material expression</summary>
	public static TArray<int> GetMaterialExpressionInputTypes(UMaterialExpression MaterialExpression) { return default; }
	...
	///<summary>Returns any nanite override material for the given material</summary>
	public static UMaterialInterface GetNaniteOverrideMaterial(UMaterialInterface Material) { return default; }
}
