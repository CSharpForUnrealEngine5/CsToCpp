...
public partial class UAbilityTask_PlayMontageAndWait : UAbilityTask {
	...
	///<summary>Callback function for when the owning Gameplay Ability is cancelled</summary>
	public void OnGameplayAbilityCancelled() {}
	...
	///<summary>bAllowInterruptAfterBlendOut</summary>
	public bool bAllowInterruptAfterBlendOut;
}
