...
public partial class UOptimusDeformerInstance : UMeshDeformerInstance {
	...
	public bool SetBoolVariable(FName InVariableName,bool InValue) { return default; }
	///<summary>Set the value of an integer variable.</summary>
	public bool SetIntVariable(FName InVariableName,int InValue) { return default; }
	///<summary>Set the value of a float variable.</summary>
	public bool SetFloatVariable(FName InVariableName,double InValue) { return default; }
	///<summary>Set the value of a 3-vector variable.</summary>
	public bool SetVectorVariable(FName InVariableName,FVector InValue) { return default; }
	///<summary>Set the value of a 4-vector variable.</summary>
	public bool SetVector4Variable(FName InVariableName,FVector4 InValue) { return default; }
	///<summary>Set the value of a transform variable.</summary>
	public bool SetTransformVariable(FName InVariableName,FTransform InValue) { return default; }
	...
	public bool EnqueueTriggerGraph(FName InTriggerGraphName) { return default; }
