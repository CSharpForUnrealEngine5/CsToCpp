...
public partial class UGeometryScriptLibrary_MeshVertexColorFunctions : UBlueprintFunctionLibrary {
	...
	///<summary>Blur the color attribute of the mesh. If the mesh has no color attribute, the function returns the mesh unchanged.</summary>
	public static UDynamicMesh BlurMeshVertexColors(UDynamicMesh TargetMesh,FGeometryScriptMeshSelection Selection,int NumIterations/*=1*/,double Strength/*=0.5*/,EGeometryScriptBlurColorMode BlurMode/*=EGeometryScriptBlurColorMode.Uniform*/,FGeometryScriptBlurMeshVertexColorsOptions Options/*=new FGeometryScriptBlurMeshVertexColorsOptions()*/,UGeometryScriptDebug Debug/*=nullptr*/) { return default; }
}
