...
public partial class USequencerToolsFunctionLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>IsRenderingMovie</summary>
	public static bool IsRenderingMovie() { return default; }
	///<summary>CancelMovieRender</summary>
	public static void CancelMovieRender() {}
	///<summary>GetBoundObjects</summary>
	...
	///<summary>GetObjectBindings</summary>
	...
	///<summary>Exports an FBX from the section to key of the control rig track of the actor with the given name.</summary>
	public static bool ExportFBXFromControlRig(ULevelSequence Sequence,string ActorWithControlRigTrack,UMovieSceneUserExportFBXControlRigSettings ExportFBXControlRigSettings) { return default; }
}
