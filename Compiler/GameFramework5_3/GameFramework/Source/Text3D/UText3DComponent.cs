...
public partial class UText3DComponent : USceneComponent {
	...
	///<summary>Set whether an outline is applied.</summary>
	public void SetHasOutline(bool bValue) {}
	///<summary>Set the outline width.</summary>
	...
	///<summary>Set the amount of segments that will be used to tessellate the Bevel</summary>
	...
	///<summary>Set the value of CastShadow.</summary>
	...
	///<summary>Whether to allow automatic refresh/mesh generation</summary>
	public bool bRefreshOnChange;
	...
	///<summary>Returns the Text property, after being formatted by the FormatText virtual function.</summary>
	public FText GetFormattedText() { return default; }
	...
	///<summary>Each character mesh is parented to a Kerning component.</summary>
	public TArray<USceneComponent> CharacterKernings;
	///<summary>Each character mesh is held in a component.</summary>
