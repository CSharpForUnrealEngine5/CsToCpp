...
public partial class UPixelStreamingBlueprints : UBlueprintFunctionLibrary {
	...
	///<summary>Set the layer preference for a specific player</summary>
	public static void SetPlayerLayerPreference(string PlayerId,int SpatialLayerId,int TemporalLayerId) {}
	///<summary>Set the layer preference for a specific player</summary>
	public static void StreamerSetPlayerLayerPreference(string StreamerId,string PlayerId,int SpatialLayerId,int TemporalLayerId) {}
	///<summary>@brief Get the connected players</summary>
	public static TArray<string> GetConnectedPlayers() { return default; }
	///<summary>@brief Get the connected players</summary>
	public static TArray<string> StreamerGetConnectedPlayers(string StreamerId) { return default; }
