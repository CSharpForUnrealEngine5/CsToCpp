...
public partial class UUsdStageEditorBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Checks to see if an USD Stage Editor window is currently opened.</summary>
	public static bool IsStageEditorOpened() { return default; }
	...
	///<summary>Returns the names of the currently selected property metadata entries on the right panel of the USD Stage</summary>
	public static TArray<string> GetSelectedPropertyMetadataNames() { return default; }
	///<summary>Sets the USD Stage Editor property metadata selection to the entries with names contained in NewSelection.</summary>
	public static void SetSelectedPropertyMetadataNames(TArray<string> NewSelection) {}
