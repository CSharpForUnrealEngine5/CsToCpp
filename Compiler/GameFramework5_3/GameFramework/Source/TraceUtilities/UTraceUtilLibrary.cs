...
public partial class UTraceUtilLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Traces a bookmark with specified name.</summary>
	public static void TraceBookmark(string Name) {}
	///<summary>Traces a begin event for a region with specified name.</summary>
	public static void TraceMarkRegionStart(string Name) {}
	///<summary>Traces an end event for a region with specified name.</summary>
