...
[CppInclude("FunctionLibraries/VCamBlueprintFunctionLibrary.h")]
public partial class UVCamBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Get playback speed in Sequencer</summary>
	public static float GetPlaybackSpeed() { return default; }
	///<summary>Set playback speed in Sequencer</summary>
	public static void SetPlaybackSpeed(float Value/*=1.0f*/) {}
}
