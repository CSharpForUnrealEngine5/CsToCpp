...
public partial class UUVLayoutPreview : UObject {
	...
	///<summary>MeshElementsVisualizer references the PreviewMesh to handle drawing the wireframes for UVs</summary>
	public UMeshElementsVisualizer MeshElementsVisualizer;
