...
public partial class UGLTFExportOptions : UObject {
	...
	///<summary>If enabled, the copyright notice from project settings will be included as metadata in the glTF asset.</summary>
	...
	///<summary>If enabled, materials with shading model clear coat will be properly exported. Uses extension KHR_materials_clearcoat.</summary>
	public bool bExportClearCoatMaterials;
	///<summary>If enabled, allows materials to have an emissive factor that exceeds the standard range [0.0, 1.0]. Uses extension KHR_materials_emissive_strength.</summary>
	...
	///<summary>If enabled, export UV offset and scale/tiling used in materials. Uses extension KHR_texture_transform.</summary>
