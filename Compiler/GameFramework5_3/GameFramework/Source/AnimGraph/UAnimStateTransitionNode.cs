...
public partial class UAnimStateTransitionNode : UAnimStateNodeBase {
	...
	///<summary>Try setting the rule automatically based on most relevant asset player node&#39;s remaining time and the Automatic Rule Trigger Time of the transition, ignoring the internal time</summary>
	public bool bAutomaticRuleBasedOnSequencePlayerInState;
	///<summary>When should the automatic transition rule trigger relative to the time remaining on the relevant asset player:</summary>
