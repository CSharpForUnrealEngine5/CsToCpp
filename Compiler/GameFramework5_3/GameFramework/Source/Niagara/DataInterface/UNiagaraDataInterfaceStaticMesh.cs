...
public partial class UNiagaraDataInterfaceStaticMesh : UNiagaraDataInterface {
	...
	///<summary>If true we capture the transforms from the mesh component each frame.</summary>
	...
	///<summary>When attached to an Instanced Static Mesh, which instance should be read from.</summary>
	public int InstanceIndex;
	///<summary>List of filtered sockets to use.</summary>
	public TArray<FName> FilteredSockets;
	///<summary>SetNiagaraStaticMeshDIInstanceIndex</summary>
