...
public partial class UNiagaraSystem : UFXSystemAsset {
	...
	///<summary>An effect types defines settings shared between systems, for example scalability and validation rules.</summary>
	...
	///<summary>The fixed bounding box value for the whole system. When placed in the level and the bounding box is not visible to the camera, the effect is culled from rendering.</summary>
	...
	public TMap<FGuid,UNiagaraMessageDataBase> MessageKeyToMessageMap_DEPRECATED;
	///<summary>MessageStore</summary>
