...
public partial class UNiagaraDataChannelReader : UObject {
	...
	public bool InitAccess(FNiagaraDataChannelSearchParameters SearchParams,bool bReadPrevFrameData) { return default; }
	///<summary>Num</summary>
	...
	public FVector ReadPosition(FName VarName,int Index) { return default; }
}
