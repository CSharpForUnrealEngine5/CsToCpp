...
public partial class UNiagaraSettings : UDeveloperSettings {
	...
	///<summary>Whether to limit the max tick delta time or not.</summary>
	public bool bLimitDeltaTime;
	///<summary>Limits the delta time per tick for emitters to prevent simulation spikes due to frame lags.</summary>
	...
	///<summary>Specifies a required effect type which must be used for effects in the project.</summary>
