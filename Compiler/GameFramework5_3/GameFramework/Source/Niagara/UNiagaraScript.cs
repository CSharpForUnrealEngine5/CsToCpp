...
public partial class UNiagaraScript : UNiagaraScriptBase {
	...
	///<summary>ResolvedDataInterfaces</summary>
	public TArray<FNiagaraScriptResolvedDataInterfaceInfo> ResolvedDataInterfaces;
	///<summary>ResolvedUserDataInterfaceBindings</summary>
	public TArray<FNiagaraResolvedUserDataInterfaceBinding> ResolvedUserDataInterfaceBindings;
	///<summary>Populated from compilation process, used to generate resolved list</summary>
	public TArray<FNiagaraScriptUObjectCompileInfo> CachedDefaultUObjects;
	///<summary>Resolved objects are used to populate the script parameter stores, they are 1:1 mapping from variable -&gt; object</summary>
