...
public partial class UCustomizableObjectNodeObject : UCustomizableObjectNode {
	...
	///<summary>Soft references SkeletalMeshes found in the previous compilation.</summary>
	...
	///<summary>Array of bones to remove from the mesh.All influences assigned to these bones will be transferred to the closest valid bone.</summary>
	public TArray<FComponentSettings> ComponentSettings;
