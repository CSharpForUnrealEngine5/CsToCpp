...
public partial class UCustomizableObjectNodeMaterial : UCustomizableObjectNodeMaterialBase {
	...
	///<summary>Reuse material between LODs when using the LODStrategy - Automatic from mesh. If the material is extended or edited by a CO using</summary>
	public bool bReuseMaterialBetweenLODs;
