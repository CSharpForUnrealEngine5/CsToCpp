...
public partial class UWaterRuntimeSettings : UDeveloperSettings {
	...
	///<summary>If enabled, MapCheck will notify users that their ocean does not completely fill the water zone. This can be desirable in some cases but the default should be to fill completely.</summary>
	public bool bWarnOnMismatchOceanExtent;
