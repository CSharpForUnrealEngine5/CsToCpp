...
public partial class UWaterBodyComponent : UPrimitiveComponent {
	...
	///<summary>Returns water static mesh MID</summary>
	public UMaterialInstanceDynamic GetWaterStaticMeshMaterialInstance() { return default; }
	///<summary>GetWaterLODMaterialInstance</summary>
	...
	///<summary>Override the default behavior of water bodies finding their water zone based on bounds and set a specific water zone to which this water body should register.</summary>
	public void SetWaterZoneOverride(TSoftObjectPtr<AWaterZone> InWaterZoneOverride) {}
	...
	///<summary>WaterStaticMeshMaterial</summary>
	public UMaterialInterface WaterStaticMeshMaterial;
	...
	public FWaterBodyStaticMeshSettings StaticMeshSettings;
	...
	///<summary>WaterStaticMeshMID</summary>
	public UMaterialInstanceDynamic WaterStaticMeshMID;
	...
	///<summary>WaterLODMaterial_DEPRECATED</summary>
	public UMaterialInterface WaterLODMaterial_DEPRECATED;
