...
public partial class ADMXFixtureActor : ADMXFixtureActorBase {
	...
	///<summary>Updates the spotlight intensity.</summary>
	...
	///<summary>MinQuality_DEPRECATED</summary>
	public float MinQuality_DEPRECATED;
	///<summary>MaxQuality_DEPRECATED</summary>
	public float MaxQuality_DEPRECATED;
}
