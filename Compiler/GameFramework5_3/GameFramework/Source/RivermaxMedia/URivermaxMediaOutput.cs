...
public partial class URivermaxMediaOutput : UMediaOutput {
	...
	///<summary>For alignment point mode, controls whether we stall engine before capturing if there are no buffer available to capture into</summary>
	public ERivermaxFrameLockingMode FrameLockingMode;
	///<summary>Number of frames that can be queued / used in output queue. Frame being sent counts for 1.</summary>
	public int PresentationQueueSize;
