...
public partial class UUpdateManager : UObject {
	...
	///<summary>Amount of time to wait before starting an update check.</summary>
	public float UpdateCheckStartDelay;
	///<summary>Amount of time to wait before returning a cached response when updates are started.</summary>
	public float UpdateCheckCachedResponseDelay;
