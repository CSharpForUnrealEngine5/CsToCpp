...
public partial class UAutomationControllerSettings : UObject {
	...
	///<summary>Whether to automatically expand Automation Tests tree subgroups that have single non-leaf item as a child (default=true)</summary>
	public bool bAutoExpandSingleItemSubgroups;
