...
public partial class UScriptableInteractiveTool : UInteractiveTool {
	...
	public void RequestToolShutdown(bool bAccept,bool bShowUserPopupMessage,FText UserMessage) {}
	...
	///<summary>The OnGizmoTransformStateChange event fires whenever the user start/ends a Gizmo transform, or when an Undo/Redo event occurs.</summary>
	public void OnGizmoTransformStateChange(string GizmoIdentifier,FTransform CurrentTransform,EScriptableToolGizmoStateChangeType ChangeType) {}
