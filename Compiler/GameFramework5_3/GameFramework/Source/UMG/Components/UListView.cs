...
public partial class UListView : UListViewBase {
	...
	///<summary>This deprecated property was originally BlueprintReadOnly. To satisfy the compiler requirment to have a BlueprintGetter for this property,</summary>
	public float EntrySpacing;
	///<summary>HorizontalEntrySpacing</summary>
	public float HorizontalEntrySpacing;
	///<summary>VerticalEntrySpacing</summary>
	public float VerticalEntrySpacing;
	///<summary>Get the horizontal spacing between entries.</summary>
	public float GetHorizontalEntrySpacing() { return default; }
	///<summary>Get the vertical spacing between entries.</summary>
	public float GetVerticalEntrySpacing() { return default; }
