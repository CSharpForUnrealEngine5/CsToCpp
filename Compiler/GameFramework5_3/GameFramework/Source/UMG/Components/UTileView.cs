...
public partial class UTileView : UListView {
	...
	///<summary>Returns whether the TileView is left, right or center aligned.</summary>
	public bool IsAligned() { return default; }
	...
	///<summary>True if entry dimensions should be the sum of the entry widget dimensions and the spacing.</summary>
