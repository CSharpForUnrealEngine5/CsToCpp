...
public partial class UWidgetBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Draws text.</summary>
	public static void DrawTextFormatted(FPaintContext Context,FText Text,FVector2D Position,UFont Font,float FontSize/*=16.0f*/,FName FontTypeFace/*=new FName(TEXT("Regular"))*/,FLinearColor Tint/*=FLinearColor.White*/) {}
