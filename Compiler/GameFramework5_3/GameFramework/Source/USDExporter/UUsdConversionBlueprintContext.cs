...
public partial class UUsdConversionBlueprintContext : UObject {
	...
	///<summary>ConvertMaterialOverrides</summary>
	public bool ConvertMaterialOverrides(UObject MeshAsset,TArray<UMaterialInterface> MaterialOverrides,string PrimPath,int LowestLOD,int HighestLOD) { return default; }
