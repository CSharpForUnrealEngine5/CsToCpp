...
public partial class UUsdConversionBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Returns how many total Unreal levels (persistent + all sublevels) will be exported if we consider LevelsToIgnore</summary>
	public static int GetNumLevelsToExport(UWorld World,TSet<string> LevelsToIgnore) { return default; }
	...
	///<summary>AddReference</summary>
	public static void AddReference(string ReferencingStagePath,string ReferencingPrimPath,string TargetStagePath) {}
