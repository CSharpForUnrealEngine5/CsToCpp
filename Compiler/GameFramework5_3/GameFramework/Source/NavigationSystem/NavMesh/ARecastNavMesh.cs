...
public partial class ARecastNavMesh : ANavigationData {
	...
	///<summary>AgentMaxStepHeight</summary>
	...
	///<summary>If &gt;= 1, when sorting pending tiles by priority, tiles near invokers (within the distance threshold) will have their priority increased.</summary>
	public uint InvokerTilePriorityBumpDistanceThresholdInTileUnits;
	///<summary>Priority increase steps for tiles that are withing near distance.</summary>
