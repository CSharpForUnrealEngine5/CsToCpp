...
public partial class UNavLinkCustomComponent : UNavRelevantComponent {
	...
	///<summary>NavLinkUserId</summary>
	public uint NavLinkUserId;
	///<summary>link Id assigned by navigation system</summary>
	public FNavLinkId CustomLinkId;
	///<summary>Assigned in the constructor. This uniquely identifies a component in an Actor, but will not be unique between duplicate level instances.</summary>
