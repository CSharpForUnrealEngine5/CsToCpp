...
[CppInclude("Rig/Solvers/IKRig_FBIKSolver.h")]
public partial class UIKRigFBIKSolver : UIKRigSolver {
	...
	///<summary>DEPRECATED: When true, the solver is reset each tick to start from the current input pose. Default is true.</summary>
	public bool bStartSolveFromInputPose_DEPRECATED;
