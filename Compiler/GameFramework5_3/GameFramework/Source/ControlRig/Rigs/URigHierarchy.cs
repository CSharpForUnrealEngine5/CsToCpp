...
public partial class URigHierarchy : UObject {
	...
	public void SetControlPreferredRotator(FRigElementKey InKey,FRotator InRotator,bool bInitial/*=false*/,bool bFixEulerFlips/*=false*/) {}
	///<summary>Sets a control&#39;s preferred rotator (local transform rotation)</summary>
	public void SetControlPreferredRotatorByIndex(int InElementIndex,FRotator InRotator,bool bInitial/*=false*/,bool bFixEulerFlips/*=false*/) {}
	///<summary>Returns a control&#39;s preferred euler angles (local transform rotation)</summary>
	public FVector GetControlPreferredEulerAngles(FRigElementKey InKey,EEulerRotationOrder InRotationOrder,bool bInitial/*=false*/) { return default; }
	///<summary>Returns a control&#39;s preferred euler angles (local transform rotation)</summary>
	public FVector GetControlPreferredEulerAnglesByIndex(int InElementIndex,EEulerRotationOrder InRotationOrder,bool bInitial/*=false*/) { return default; }
	///<summary>Sets a control&#39;s preferred euler angles (local transform rotation)</summary>
	public void SetControlPreferredEulerAngles(FRigElementKey InKey,FVector InEulerAngles,EEulerRotationOrder InRotationOrder,bool bInitial/*=false*/,bool bFixEulerFlips/*=false*/) {}
	///<summary>Sets a control&#39;s preferred euler angles (local transform rotation)</summary>
	public void SetControlPreferredEulerAnglesByIndex(int InElementIndex,FVector InEulerAngles,EEulerRotationOrder InRotationOrder,bool bInitial/*=false*/,bool bFixEulerFlips/*=false*/) {}
	///<summary>Returns a control&#39;s preferred euler rotation order</summary>
	public EEulerRotationOrder GetControlPreferredEulerRotationOrder(FRigElementKey InKey,bool bFromSettings/*=true*/) { return default; }
	///<summary>Returns a control&#39;s preferred euler rotation order</summary>
	public EEulerRotationOrder GetControlPreferredEulerRotationOrderByIndex(int InElementIndex,bool bFromSettings/*=true*/) { return default; }
	///<summary>Sets a control&#39;s preferred euler rotation order</summary>
	public void SetControlPreferredRotationOrder(FRigElementKey InKey,EEulerRotationOrder InRotationOrder) {}
	///<summary>Sets a control&#39;s preferred euler rotation order</summary>
	public void SetControlPreferredRotationOrderByIndex(int InElementIndex,EEulerRotationOrder InRotationOrder) {}
