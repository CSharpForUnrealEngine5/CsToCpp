...
public partial class URigHierarchyController : UObject {
	...
	public FRigElementKey AddBone(FName InName,FRigElementKey InParent,FTransform InTransform,bool bTransformInGlobal/*=true*/,ERigBoneType InBoneType/*=ERigBoneType.User*/,bool bSetupUndo/*=false*/,bool bPrintPythonCommand/*=false*/) { return default; }
	///<summary>Adds a null to the hierarchy</summary>
	public FRigElementKey AddNull(FName InName,FRigElementKey InParent,FTransform InTransform,bool bTransformInGlobal/*=true*/,bool bSetupUndo/*=false*/,bool bPrintPythonCommand/*=false*/) { return default; }
	///<summary>Adds a control to the hierarchy</summary>
	public FRigElementKey AddControl_ForBlueprint(FName InName,FRigElementKey InParent,FRigControlSettings InSettings,FRigControlValue InValue,bool bSetupUndo/*=true*/,bool bPrintPythonCommand/*=false*/) { return default; }
	///<summary>Adds a control to the hierarchy</summary>
	public FRigElementKey AddAnimationChannel_ForBlueprint(FName InName,FRigElementKey InParentControl,FRigControlSettings InSettings,bool bSetupUndo/*=true*/,bool bPrintPythonCommand/*=false*/) { return default; }
	///<summary>Adds a curve to the hierarchy</summary>
	public FRigElementKey AddCurve(FName InName,float InValue/*=0.0f*/,bool bSetupUndo/*=true*/,bool bPrintPythonCommand/*=false*/) { return default; }
	///<summary>Adds a rigidbody to the hierarchy</summary>
	public FRigElementKey AddRigidBody(FName InName,FRigElementKey InParent,FRigRigidBodySettings InSettings,FTransform InLocalTransform,bool bSetupUndo/*=false*/,bool bPrintPythonCommand/*=false*/) { return default; }
	...
	public TArray<FRigElementKey> ImportBones(USkeleton InSkeleton,FName InNameSpace/*=NAME_None*/,bool bReplaceExistingBones/*=true*/,bool bRemoveObsoleteBones/*=true*/,bool bSelectBones/*=false*/,bool bSetupUndo/*=false*/,bool bPrintPythonCommand/*=false*/) { return default; }
	///<summary>Imports an existing skeleton to the hierarchy</summary>
	public TArray<FRigElementKey> ImportBonesFromAsset(string InAssetPath,FName InNameSpace/*=NAME_None*/,bool bReplaceExistingBones/*=true*/,bool bRemoveObsoleteBones/*=true*/,bool bSelectBones/*=false*/,bool bSetupUndo/*=false*/) { return default; }
	///<summary>Imports all curves from a skeleton to the hierarchy</summary>
	public TArray<FRigElementKey> ImportCurves(USkeleton InSkeleton,FName InNameSpace/*=NAME_None*/,bool bSelectCurves/*=false*/,bool bSetupUndo/*=false*/,bool bPrintPythonCommand/*=false*/) { return default; }
	///<summary>Imports all curves from a skeleton to the hierarchy</summary>
	public TArray<FRigElementKey> ImportCurvesFromAsset(string InAssetPath,FName InNameSpace/*=NAME_None*/,bool bSelectCurves/*=false*/,bool bSetupUndo/*=false*/) { return default; }
	...
	public FRigElementKey RenameElement(FRigElementKey InElement,FName InName,bool bSetupUndo/*=false*/,bool bPrintPythonCommand/*=false*/,bool bClearSelection/*=true*/) { return default; }
	...
	public FName SetDisplayName(FRigElementKey InControl,FName InDisplayName,bool bRenameElement/*=false*/,bool bSetupUndo/*=false*/,bool bPrintPythonCommand/*=false*/) { return default; }
