...
public partial class UControlRig : URigVMHost {
	...
	public UTransformableControlHandle CreateTransformableControlHandle(UObject Outer,FName ControlName) { return default; }
	...
	public virtual TArray<FName> CurrentControlSelection() { return default; }
	///<summary>IsControlSelected</summary>
	public virtual bool IsControlSelected(FName InControlName) { return default; }
	...
	///<summary>ShapeLibraryNameMap</summary>
	public TMap<string,string> ShapeLibraryNameMap;
	///<summary>you either go Input or Output, currently if you put it in both place, Output will override</summary>
	public TMap<FName,FCachedPropertyPath> InputProperties_DEPRECATED;
	///<summary>OutputProperties_DEPRECATED</summary>
	public TMap<FName,FCachedPropertyPath> OutputProperties_DEPRECATED;
