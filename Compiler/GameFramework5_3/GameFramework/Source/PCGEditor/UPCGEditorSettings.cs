...
public partial class UPCGEditorSettings : UObject {
	...
	///<summary>Highlighted node body tint color, used to indicate available data sources in hierarchical graphs</summary>
	public FLinearColor HighlightedNodeBodyTintColor;
	...
	///<summary>Color used for control flow operations</summary>
	public FLinearColor ControlFlowNodeColor;
	///<summary>Color used for hierarchical generation operations</summary>
	public FLinearColor HierarchicalGenerationNodeColor;
