...
public partial class UHeadMountedDisplayFunctionLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>ConfigureGestures</summary>
	...
	public static bool GetControllerTransformForTime2(UObject WorldContext,int ControllerIndex,FName MotionSource,FTimespan Time,bool bTimeWasUsed,FRotator Orientation,FVector Position,bool bProvidedLinearVelocity,FVector LinearVelocity,bool bProvidedAngularVelocity,FRotator AngularVelocity,bool bProvidedLinearAcceleration,FVector LinearAcceleration) { return default; }
	///<summary>Get the transform and potentially velocity data at a specified time near the current frame in unreal world space.</summary>
	public static bool GetControllerTransformForTime(UObject WorldContext,int ControllerIndex,FName MotionSource,FTimespan Time,bool bTimeWasUsed,FRotator Orientation,FVector Position,bool bProvidedLinearVelocity,FVector LinearVelocity,bool bProvidedAngularVelocity,FVector AngularVelocityAsAxisAndLength,bool bProvidedLinearAcceleration,FVector LinearAcceleration) { return default; }
