...
public partial class UCineSplineComponent : USplineComponent {
	...
	///<summary>Toggle if visualizer displays normalized position or absolute position</summary>
	public bool bShouldVisualizeNormalizedPosition;
	///<summary>Whether spline length value should be displayed in visualizer</summary>
	public bool bShouldVisualizeSplineLength;
	///<summary>Whether point rotation arrows should be displayed in visualizer</summary>
	public bool bShouldVisualizePointRotation;
}
