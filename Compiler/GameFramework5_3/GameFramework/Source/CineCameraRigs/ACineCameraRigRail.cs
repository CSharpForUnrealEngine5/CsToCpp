...
public partial class ACineCameraRigRail : ACameraRig_Rail {
	...
	///<summary>Enable speed visualization. Automatically disabled when position property is driven in Sequencer</summary>
	public bool bDisplaySpeedHeatmap;
	///<summary>Number of speed samples per spline segment</summary>
	public int SpeedSampleCountPerSegment;
	...
	///<summary>Drive Mode to update position in tick</summary>
	public ECineCameraRigRailDriveMode DriveMode;
	///<summary>Specifies the drive speed of the rig rail in centimeter per second</summary>
	public float Speed;
	///<summary>Enable loop in speed or duration mode</summary>
	public bool bLoop;
	...
	///<summary>Set drive mode</summary>
	public void SetDriveMode(ECineCameraRigRailDriveMode InMode) {}
	///<summary>Enable display speed heatmap</summary>
	public void SetDisplaySpeedHeatmap(bool bEnable) {}
	///<summary>Returns true if the rig rail is driven by Sequencer</summary>
	public bool IsSequencerDriven() { return default; }
	///<summary>CineSplineComponent</summary>
	public UCineSplineComponent CineSplineComponent;
	///<summary>Check if the rig rail is driven by Sequencer</summary>
	public void OnSequencerCheck() {}
}
