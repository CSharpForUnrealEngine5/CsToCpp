...
public partial class UTargetingSelectionTask_AOE : UTargetingTask {
	...
	///<summary>Native event to get the source rotation for the AOE</summary>
	public FQuat GetSourceRotation(FTargetingRequestHandle TargetingHandle) { return default; }
	...
	///<summary>Should we offset based on world or relative Source object transform?</summary>
