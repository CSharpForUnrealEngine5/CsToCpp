...
public partial class UMediaPlayer : UObject {
	...
	///<summary>Get the media&#39;s current playback time as appropriate for display.</summary>
	public FTimespan GetDisplayTime() { return default; }
	///<summary>Get the media&#39;s current playback timestamp.</summary>
	public UMediaTimeStampInfo GetTimeStamp() { return default; }
	///<summary>Get the media&#39;s current playback timestamp as appropriate for display.</summary>
	public UMediaTimeStampInfo GetDisplayTimeStamp() { return default; }
	...
	///<summary>This is the blueprint accessible version of the GetMediaMetadata.</summary>
	public TMap<string,FMediaMetadataItemsBPT> GetMediaMetadataItems() { return default; }
