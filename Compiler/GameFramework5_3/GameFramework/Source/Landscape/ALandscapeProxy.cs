...
public partial class ALandscapeProxy : APartitionActor {
	...
	///<summary>Guid for LandscapeEditorInfo, all proxies that belong to the same landscape should have the same LandscapeGuid, even if split across world partitions</summary>
	...
	///<summary>bNaniteSkirtEnabled</summary>
	public bool bNaniteSkirtEnabled;
	///<summary>NaniteSkirtDepth</summary>
	...
	///<summary>Specifies the LOD Group (Zero is No Group). All landscapes in the same group calculate their LOD together, allowing matching border LODs to fix geometry seams.</summary>
	...
	///<summary>NaniteComponent_DEPRECATED</summary>
	public ULandscapeNaniteComponent NaniteComponent_DEPRECATED;
	///<summary>NaniteComponents</summary>
	...
	///<summary>Control shadow invalidation behavior, in particular with respect to Virtual Shadow Maps and material effects like World Position Offset.</summary>
	...
	///<summary>Enable compressed heightmap texture storage.</summary>
