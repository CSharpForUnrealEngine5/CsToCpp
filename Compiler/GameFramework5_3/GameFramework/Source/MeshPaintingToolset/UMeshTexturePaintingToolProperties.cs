...
public partial class UMeshTexturePaintingToolProperties : UBrushBaseProperties {
	...
	///<summary>Optional Texture Brush to which Painting should use</summary>
	public UTexture2D PaintBrush;
	///<summary>Initial Rotation offset to apply to our paint brush</summary>
	public float PaintBrushRotationOffset;
	///<summary>Whether or not to continously rotate the brush towards the painting direction</summary>
	public bool bRotateBrushTowardsDirection;
