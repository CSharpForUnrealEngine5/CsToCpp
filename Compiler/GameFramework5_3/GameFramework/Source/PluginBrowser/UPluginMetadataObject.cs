...
public partial class UPluginMetadataObject : UObject {
	...
	///<summary>Optional custom virtual path to display in editor to better organize. Inserted just before this plugin&#39;s directory in the path: /All/Plugins/EditorCustomVirtualPath/PluginName</summary>
	public string EditorCustomVirtualPath;
	...
	///<summary>If true, prevents other plugins from depending on this plugin</summary>
	public bool bIsSealed;
	///<summary>bNoCode</summary>
	public bool bNoCode;
	///<summary>Plugins used by this plugin</summary>
	public TArray<FPluginReferenceMetadata> Plugins;
	///<summary>Plugins that cannot be used by this plugin</summary>
	public TArray<string> DisallowedPlugins;
	///<summary>GetAvailablePluginDependencies</summary>
	public TArray<string> GetAvailablePluginDependencies() { return default; }
	///<summary>GetDisallowedPluginsOptions</summary>
	public TArray<string> GetDisallowedPluginsOptions() { return default; }
}
