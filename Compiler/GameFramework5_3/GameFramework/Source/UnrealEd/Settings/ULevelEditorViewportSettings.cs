...
public partial class ULevelEditorViewportSettings : UObject {
	...
	///<summary>Camera movement notification toggle to switch back to the behavior that caused camera notifications to be sent during gizmo movement.</summary>
	public bool bUseLegacyCameraMovementNotifications;
	...
	///<summary>Store the last camera settings for all the viewport of each world loaded in the editor.</summary>
	public TMap<TSoftObjectPtr<UWorld>,FLevelEditorViewporEditorViews> EditorViews;
