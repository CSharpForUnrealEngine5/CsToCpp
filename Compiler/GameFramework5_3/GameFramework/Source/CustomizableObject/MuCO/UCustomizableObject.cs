...
public partial class UCustomizableObject : UObject {
	...
	///<summary>ReferencedPassThroughTextures</summary>
	public TArray<TSoftObjectPtr<UTexture>> ReferencedPassThroughTextures;
	...
	///<summary>mu::ExtensionData::Index is an index into this array when mu::ExtensionData::Origin is ConstantAlwaysLoaded</summary>
	public TArray<FCustomizableObjectExtensionData> AlwaysLoadedExtensionData;
	///<summary>mu::ExtensionData::Index is an index into this array when mu::ExtensionData::Origin is ConstantStreamed</summary>
	public TArray<FCustomizableObjectStreamedExtensionData> StreamedExtensionData;
	///<summary>Use the SkeletalMesh of reference as a placeholder until the custom mesh is ready to use.</summary>
	public bool bEnableUseRefSkeletalMeshAsPlaceholder;
	...
	///<summary>bEnableAnimBpPhysicsAssetsManipualtion</summary>
	public bool bEnableAnimBpPhysicsAssetsManipualtion;
	...
	///<summary>Called to load the reference SkeletalMesh if it needs to be used as a placeholder and it&#39;s not loaded.</summary>
	public void LoadReferenceSkeletalMeshesAsync() {}
	///<summary>UnloadReferenceSkeletalMeshes</summary>
	public void UnloadReferenceSkeletalMeshes() {}
	///<summary>Get the default value of a parameter of type Float.</summary>
	public float GetFloatParameterDefaultValue(string InParameterName) { return default; }
	///<summary>Get the default value of a parameter of type Int.</summary>
	public int GetIntParameterDefaultValue(string InParameterName) { return default; }
	///<summary>Get the default value of a parameter of type Bool.</summary>
	public bool GetBoolParameterDefaultValue(string InParameterName) { return default; }
	///<summary>Get the default value of a parameter of type Color.</summary>
	public FLinearColor GetColorParameterDefaultValue(string InParameterName) { return default; }
	///<summary>Get the default value of a parameter of type Projector.</summary>
	public void GetProjectorParameterDefaultValue(string InParameterName,FVector3f OutPos,FVector3f OutDirection,FVector3f OutUp,FVector3f OutScale,float OutAngle,ECustomizableObjectProjectorType OutType) {}
	///<summary>Return true or false depending if the parameter at the index provided is multidimensional or not.</summary>
	public bool IsParameterMultidimensional(string InParameterName) { return default; }
	...
	///<summary>Textures marked as low priority will generate defaulted resident mips (if texture streaming is enabled).</summary>
	public TArray<FName> LowPriorityTextures;
	...
	///<summary>AnimBpOverridePhysiscAssetsInfo</summary>
	public TArray<FAnimBpOverridePhysicsAssetsInfo> AnimBpOverridePhysiscAssetsInfo;
	...
	///<summary>Stores the bone names of all the bones that can possibly use the generated meshes</summary>
