...
public partial class UMovieSceneToolsProjectSettings : UObject {
	...
	///<summary>The default directory for the subsequences.</summary>
	public string SubsequenceDirectory;
	///<summary>The default directory for the shots.</summary>
	public string ShotDirectory;
	///<summary>The default prefix for subsequence names.</summary>
	public string SubsequencePrefix;
