...
public partial class UEditorUtilityLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Gets the current content browser path if one is open, whether it is internal or virtual.</summary>
	public static FContentBrowserItemPath GetCurrentContentBrowserItemPath() { return default; }
	...
	///<summary>Returns the folders that are selected in the path view for the content browser</summary>
	public static TArray<string> GetSelectedPathViewFolderPaths() { return default; }
	...
	///<summary>ConvertToEditorUtilityWidget</summary>
