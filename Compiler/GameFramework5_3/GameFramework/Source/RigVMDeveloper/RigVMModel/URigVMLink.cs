...
public partial class URigVMLink : UObject {
	...
	///<summary>Returns the graph nesting depth of this link</summary>
	...
	///<summary>Returns the source Node of this Link (or nullptr)</summary>
	public URigVMNode GetSourceNode() { return default; }
	///<summary>Returns the target Node of this Link (or nullptr)</summary>
	public URigVMNode GetTargetNode() { return default; }
