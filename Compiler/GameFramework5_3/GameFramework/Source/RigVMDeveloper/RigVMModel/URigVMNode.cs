...
public partial class URigVMNode : UObject {
	...
	///<summary>Returns the graph nesting depth of this node</summary>
	...
	///<summary>GetDecoratorPins</summary>
	public TArray<URigVMPin> GetDecoratorPins() { return default; }
	///<summary>IsDecoratorPin</summary>
	public bool IsDecoratorPin(FName InName) { return default; }
	...
	///<summary>DecoratorRootPinNames</summary>
	public TArray<string> DecoratorRootPinNames;
