...
public partial class URigVMPin : UObject {
	...
	///<summary>Returns true if this pin is an array that should be displayed as elements only</summary>
	public bool ShouldOnlyShowSubPins() { return default; }
	///<summary>Returns true if this pin&#39;s subpins should be hidden in the UI</summary>
	public bool ShouldHideSubPins() { return default; }
	...
	///<summary>Returns true if this pin represents a decorator</summary>
	public bool IsDecoratorPin() { return default; }
