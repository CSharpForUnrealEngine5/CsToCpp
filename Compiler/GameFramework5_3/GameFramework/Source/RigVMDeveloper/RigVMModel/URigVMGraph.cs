...
public partial class URigVMGraph : UObject {
	...
	///<summary>Returns true if the graph contains a link given its string representation</summary>
	public bool ContainsLink(string InPinPathRepresentation) { return default; }
	...
	///<summary>Returns the root / top level parent graph of this graph (or this if it is the root graph)</summary>
	public int GetGraphDepth() { return default; }
	...
	///<summary>Returns array of event names</summary>
	public TArray<FName> GetEventNames() { return default; }
	...
	public virtual string GetNodePath() { return default; }
	...
	public virtual URigVMFunctionLibrary GetDefaultFunctionLibrary() { return default; }
	...
	///<summary>LastStructureHash</summary>
