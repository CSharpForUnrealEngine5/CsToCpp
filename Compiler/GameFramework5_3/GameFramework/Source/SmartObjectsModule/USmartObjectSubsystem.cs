...
public partial class USmartObjectSubsystem : UWorldSubsystem {
	...
	///<summary>Spatial lookup for first slot in range respecting request criteria and selection conditions.</summary>
	public FSmartObjectRequestResult FindSmartObject(FSmartObjectRequest Request,AActor UserActor/*=nullptr*/) { return default; }
	///<summary>Spatial lookup for slot candidates respecting request criteria and selection conditions.</summary>
	public bool FindSmartObjects(FSmartObjectRequest Request,TArray<FSmartObjectRequestResult> OutResults,AActor UserActor/*=nullptr*/) { return default; }
	///<summary>Blueprint function for spatial lookup for slot candidates respecting request criteria and selection conditions.</summary>
	public bool FindSmartObjects_BP(FSmartObjectRequest Request,TArray<FSmartObjectRequestResult> OutResults,AActor UserActor/*=nullptr*/) { return default; }
	///<summary>Claim</summary>
	public FSmartObjectClaimHandle Claim(FSmartObjectRequestResult RequestResult,AActor UserActor/*=nullptr*/) { return default; }
	///<summary>Use</summary>
