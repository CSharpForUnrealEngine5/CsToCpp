...
public partial class USmartObjectBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Marks a smart object slot from a request result as claimed.</summary>
	public static FSmartObjectClaimHandle MarkSmartObjectSlotAsClaimed(UObject WorldContextObject,FSmartObjectSlotHandle SlotHandle,AActor UserActor/*=nullptr*/) { return default; }
	///<summary>Marks a previously claimed smart object slot as occupied.</summary>
	public static USmartObjectBehaviorDefinition MarkSmartObjectSlotAsOccupied(UObject WorldContextObject,FSmartObjectClaimHandle ClaimHandle,UClass DefinitionClass) { return default; }
	///<summary>Marks a claimed or occupied smart object as free.</summary>
	public static bool MarkSmartObjectSlotAsFree(UObject WorldContextObject,FSmartObjectClaimHandle ClaimHandle) { return default; }
