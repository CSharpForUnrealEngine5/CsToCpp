...
public partial class UAndroidRuntimeSettings : UObject {
	...
	///<summary>Allow resizing of the window on Android devices with splitscreen</summary>
	public bool bAllowResizing;
	///<summary>Allow support for size change when foldable and flip devices change screen or layout on Android 10+</summary>
	...
	///<summary>Package for Oculus Mobile devices. When enabled, it will enable build support for arm64 and vulkan, and disable build support for x86_64, Vulkan Desktop, and OpenGL.</summary>
	...
	///<summary>Whether to enable LOD streaming for landscape visual meshes. Only supported on feature level Mobile or above.</summary>
