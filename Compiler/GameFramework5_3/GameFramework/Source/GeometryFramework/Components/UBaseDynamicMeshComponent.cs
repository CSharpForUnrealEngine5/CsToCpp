...
public partial class UBaseDynamicMeshComponent : UMeshComponent {
	...
	///<summary>Color Space Transform that will be applied to the colors stored in the DynamicMesh Attribute Color Overlay when</summary>
	public EDynamicMeshVertexColorTransformMode ColorSpaceMode;
	///<summary>Configure the active Color Space Transform Mode</summary>
	public virtual void SetVertexColorSpaceTransformMode(EDynamicMeshVertexColorTransformMode NewMode) {}
	///<summary>@return active Color Override mode</summary>
	public virtual EDynamicMeshVertexColorTransformMode GetVertexColorSpaceTransformMode() { return default; }
