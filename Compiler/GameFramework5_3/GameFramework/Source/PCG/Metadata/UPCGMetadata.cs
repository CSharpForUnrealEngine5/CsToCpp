...
public partial class UPCGMetadata : UObject {
	...
	///<summary>Unparents current metadata by flattening the attributes (values, entries, etc.)</summary>
	public void Flatten() {}
	...
	///<summary>CreateNameAttribute</summary>
	public void CreateNameAttribute(FName AttributeName,FName DefaultValue,bool bAllowsInterpolation,bool bOverrideParent/*=true*/) {}
