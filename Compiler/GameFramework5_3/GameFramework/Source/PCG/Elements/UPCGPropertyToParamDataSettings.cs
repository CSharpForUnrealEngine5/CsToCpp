...
public partial class UPCGPropertyToParamDataSettings : UPCGSettings {
	...
	///<summary>By default, attribute name will be None, but it can be overridden by this name.</summary>
	...
	public FName ActorSelectionTag_DEPRECATED;
	///<summary>ActorSelectionName_DEPRECATED</summary>
	public FName ActorSelectionName_DEPRECATED;
