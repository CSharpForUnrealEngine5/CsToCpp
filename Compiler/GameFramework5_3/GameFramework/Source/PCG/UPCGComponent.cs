...
public partial class UPCGComponent : UActorComponent {
	...
	///<summary>GenerationGridSize</summary>
	public uint GenerationGridSize;
	...
	///<summary>If any graph edges cross execution grid sizes, data on the edge is stored / retrieved from this map.</summary>
	public TMap<string,FPCGDataCollection> PerPinGeneratedOutput;
	///<summary>bIsComponentLocal</summary>
	public bool bIsComponentLocal;
	///<summary>InspectionCache</summary>
	public TMap<FPCGStack,FPCGDataCollection> InspectionCache;
}
