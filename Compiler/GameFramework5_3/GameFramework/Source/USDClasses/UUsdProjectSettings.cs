...
public partial class UUsdProjectSettings : UDeveloperSettings {
	...
	///<summary>The directories that will be used as the default search path by USD&#39;s default resolver</summary>
	public TArray<FDirectoryPath> DefaultResolverSearchPath;
	...
	///<summary>Whether to show the warning dialog when authoring opinions inside an instance or instance proxy</summary>
	public EUsdEditInInstanceBehavior EditInInstanceableBehavior;
	...
	///<summary>Whether to show the warning dialog when authoring a transforms directly to a camera component</summary>
	public bool bShowTransformOnCameraComponentWarning;
