...
public partial class UBlueprintGameplayTagLibrary : UBlueprintFunctionLibrary {
	...
	///<summary>Creates a literal FGameplayTagQuery with a prepopulated AnyTagsMatch expression</summary>
	public static FGameplayTagQuery MakeGameplayTagQuery_MatchAnyTags(FGameplayTagContainer InTags) { return default; }
	///<summary>Creates a literal FGameplayTagQuery with a prepopulated AllTagsMatch expression</summary>
	public static FGameplayTagQuery MakeGameplayTagQuery_MatchAllTags(FGameplayTagContainer InTags) { return default; }
	///<summary>Creates a literal FGameplayTagQuery with a prepopulated NoTagsMatch expression</summary>
	public static FGameplayTagQuery MakeGameplayTagQuery_MatchNoTags(FGameplayTagContainer InTags) { return default; }
