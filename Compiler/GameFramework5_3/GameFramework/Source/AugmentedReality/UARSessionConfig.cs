...
public partial class UARSessionConfig : UDataAsset {
	...
	///<summary>Remove a candidate image from the ARSessionConfig, by pointer, note the image object must match, not the content of the image.</summary>
	public void RemoveCandidateImage(UARCandidateImage CandidateImage) {}
	///<summary>Remove a candidate image from the ARSessionConfig, by index.</summary>
	public void RemoveCandidateImageAtIndex(int Index) {}
	///<summary>Remove all candidate images from the ARSessionConfig</summary>
	public void ClearCandidateImages() {}
