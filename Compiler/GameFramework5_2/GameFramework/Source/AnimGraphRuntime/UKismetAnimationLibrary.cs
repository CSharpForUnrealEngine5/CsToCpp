...
public partial class UKismetAnimationLibrary : UBlueprintFunctionLibrary {
	...
	public static float K2_DistanceBetweenTwoSocketsAndMapRange(USkeletalMeshComponent Component,FName SocketOrBoneNameA,ERelativeTransformSpace SocketSpaceA,FName SocketOrBoneNameB,ERelativeTransformSpace SocketSpaceB,bool bRemapRange,float InRangeMin,float InRangeMax,float OutRangeMin,float OutRangeMax) { return default; }
	///<summary>Computes the direction between two bones / sockets.</summary>
	public static FVector K2_DirectionBetweenSockets(USkeletalMeshComponent Component,FName SocketOrBoneNameFrom,FName SocketOrBoneNameTo) { return default; }
	...
	public static float K2_CalculateVelocityFromSockets(float DeltaSeconds,USkeletalMeshComponent Component,FName SocketOrBoneName,FName ReferenceSocketOrBone,ERelativeTransformSpace SocketSpace,FVector OffsetInBoneSpace,FPositionHistory History,int NumberOfSamples,float VelocityMin,float VelocityMax,EEasingFuncType EasingType,FRuntimeFloatCurve CustomCurve) { return default; }
