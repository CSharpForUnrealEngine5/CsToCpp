...
public partial class UPersonaToolMenuContext : UObject {
	...
	///<summary>Get the skeletal mesh that we are editing</summary>
	public  USkeletalMesh GetMesh() { return default; }
	///<summary>Get the anim blueprint that we are editing</summary>
	public  UAnimBlueprint GetAnimBlueprint() { return default; }
	///<summary>Get the animation asset that we are editing</summary>
