...
public partial class URigVM : UObject {
	...
	public virtual bool Execute(string InEntryName/*=NAME_None*/) { return default; }
	///<summary>Add a function for execute instructions to this VM.</summary>
	public virtual int AddRigVMFunction(UScriptStruct InRigVMStruct,string InMethodName) { return default; }
