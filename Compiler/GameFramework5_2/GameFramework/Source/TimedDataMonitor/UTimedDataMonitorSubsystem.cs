...
public partial class UTimedDataMonitorSubsystem : UEngineSubsystem {
	...
	public FText GetInputDisplayName(FTimedDataMonitorInputIdentifier Identifier) { return default; }
	...
	///<summary>Return the display name of an input.</summary>
	public FText GetChannelDisplayName(FTimedDataMonitorChannelIdentifier Identifier) { return default; }
