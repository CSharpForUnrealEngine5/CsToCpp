...
public partial struct FOnAssetPreImport_Dyn {
// OnAssetPreImport_Dyn__DelegateSignature(UFactory InFactory, UClass InClass, UObject InParent, string Name, string Type)
