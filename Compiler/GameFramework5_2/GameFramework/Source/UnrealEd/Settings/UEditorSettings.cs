...
public partial class UEditorSettings : UObject {
	...
	///<summary>Can the editor report usage analytics (types of assets being spawned, etc...) back to Epic in order for us to improve the editor user experience?  Note: The editor must be restarted for changes to take effect.</summary>
