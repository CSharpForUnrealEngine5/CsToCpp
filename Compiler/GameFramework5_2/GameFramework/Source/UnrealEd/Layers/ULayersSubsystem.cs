...
public partial class ULayersSubsystem : UEditorSubsystem {
	...
	public virtual bool AddActorToLayer(AActor Actor,string LayerName) { return default; }
	///<summary>Adds the provided actor to the named layers.</summary>
	public virtual bool AddActorToLayers(AActor Actor,TArray<string> LayerNames) { return default; }
	///<summary>Removes an actor from the specified layer.</summary>
	public virtual bool RemoveActorFromLayer(AActor Actor,string LayerToRemove,bool bUpdateStats/*=true*/) { return default; }
	///<summary>Removes the provided actor from the named layers.</summary>
	public virtual bool RemoveActorFromLayers(AActor Actor,TArray<string> LayerNames,bool bUpdateStats/*=true*/) { return default; }
	...
	public virtual bool AddSelectedActorsToLayer(string LayerName) { return default; }
	///<summary>Adds selected actors to the named layers.</summary>
	public virtual bool AddSelectedActorsToLayers(TArray<string> LayerNames) { return default; }
	///<summary>Removes the selected actors from the named layer.</summary>
	public virtual bool RemoveSelectedActorsFromLayer(string LayerName) { return default; }
	///<summary>Removes selected actors from the named layers.</summary>
	public virtual bool RemoveSelectedActorsFromLayers(TArray<string> LayerNames) { return default; }
	...
	public virtual void UpdateAllViewVisibility(string LayerThatChanged) {}
	...
	public virtual void SetLayerVisibility(string LayerName,bool bIsVisible) {}
	///<summary>Changes visibility of the named layers to the provided state</summary>
	public virtual void SetLayersVisibility(TArray<string> LayerNames,bool bIsVisible) {}
	///<summary>Toggles the named layer&#39;s visibility</summary>
	public virtual void ToggleLayerVisibility(string LayerName) {}
	///<summary>Toggles the visibility of all of the named layers</summary>
	public virtual void ToggleLayersVisibility(TArray<string> LayerNames) {}
	...
	public virtual bool TryGetLayer(string LayerName,ULayer OutLayer) { return default; }
	///<summary>Gets all known layers and appends their names to the provide array</summary>
	public virtual void AddAllLayerNamesTo(TArray<string> OutLayerNames) {}
	...
	public virtual void DeleteLayers(TArray<string> LayersToDelete) {}
	///<summary>Deletes the provided layer, disassociating all actors from them</summary>
	public virtual void DeleteLayer(string LayerToDelete) {}
	///<summary>Renames the provided originally named layer to the provided new name</summary>
	public virtual bool RenameLayer(string OriginalLayerName,string NewLayerName) { return default; }
