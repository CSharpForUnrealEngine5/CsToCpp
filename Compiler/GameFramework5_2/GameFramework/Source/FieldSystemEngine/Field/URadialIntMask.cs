...
// RadialIntMask
	public UObject SetRadialIntMask(float Radius,FVector Position,int InteriorValue,int ExteriorValue,ESetMaskConditionType SetMaskConditionIn) { return default; }
	public float Radius;
