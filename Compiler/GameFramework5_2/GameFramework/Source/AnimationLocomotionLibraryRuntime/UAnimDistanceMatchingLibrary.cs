...
public partial class UAnimDistanceMatchingLibrary : UBlueprintFunctionLibrary {
	...
	public static FSequenceEvaluatorReference AdvanceTimeByDistanceMatching(FAnimUpdateContext UpdateContext,FSequenceEvaluatorReference SequenceEvaluator,float DistanceTraveled,FName DistanceCurveName,FVector2D PlayRateClamp/*=new FVector2D(0.75f,1.25f)*/) { return default; }
	...
	public static FSequenceEvaluatorReference DistanceMatchToTarget(FSequenceEvaluatorReference SequenceEvaluator,float DistanceToTarget,FName DistanceCurveName) { return default; }
