...
public partial class UCustomizableObjectInstance : UObject {
	...
	///<summary>! This is only valid if bBuildParameterDecorations has been set before the last update.</summary>
	...
	///<summary>Gets the texture of a texture parameter with name &quot;TextureParamName&quot;.</summary>
	public  UTexture2D GetTextureParameterSelectedOptionT(string TextureParamName,int RangeIndex/*=-1*/) { return default; }
	///<summary>Sets the texture &quot;Texture&quot; of a texture parameter with index &quot;TextureParamIndex&quot;.</summary>
