...
public partial class UAbilitySystemComponent : UGameplayTasksComponent {
	...
	public virtual bool RemoveActiveGameplayEffect(FActiveGameplayEffectHandle Handle,int StacksToRemove/*=-1*/) { return default; }
	///<summary>Remove active gameplay effects whose backing definition are the specified gameplay effect class</summary>
	public virtual void RemoveActiveGameplayEffectBySourceEffect(UClass GameplayEffect,UAbilitySystemComponent InstigatorAbilitySystemComponent,int StacksToRemove/*=-1*/) {}
	///<summary>Get an outgoing GameplayEffectSpec that is ready to be applied to other things.</summary>
	public virtual FGameplayEffectSpecHandle MakeOutgoingSpec(UClass GameplayEffectClass,float Level,FGameplayEffectContextHandle Context) { return default; }
	///<summary>Create an EffectContext for the owner of this AbilitySystemComponent</summary>
	public virtual FGameplayEffectContextHandle MakeEffectContext() { return default; }
	...
	public virtual void UpdateActiveGameplayEffectSetByCallerMagnitude(FActiveGameplayEffectHandle ActiveHandle,FGameplayTag SetByCallerTag,float NewValue) {}
	///<summary>Dynamically update multiple set-by-caller magnitudes for an active gameplay effect</summary>
	public virtual void UpdateActiveGameplayEffectSetByCallerMagnitudes(FActiveGameplayEffectHandle ActiveHandle,TMap<FGameplayTag,float> NewSetByCallerValues) {}
	...
	public virtual void SetActiveGameplayEffectLevel(FActiveGameplayEffectHandle ActiveHandle,int NewLevel) {}
	///<summary>Updates the level of an already applied gameplay effect. The intention is that this is &#39;seemless&#39; and doesnt behave like removing/reapplying</summary>
	public virtual void SetActiveGameplayEffectLevelUsingQuery(FGameplayEffectQuery Query,int NewLevel) {}
	...
	public virtual void OnRep_ClientDebugString() {}
	///<summary>OnRep_ServerDebugString</summary>
	public virtual void OnRep_ServerDebugString() {}
	...
	public virtual void SetUserAbilityActivationInhibited(bool NewInhibit) {}
	...
	public virtual void OnRep_ActivateAbilities() {}
