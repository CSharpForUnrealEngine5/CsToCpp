...
public partial class UGameplayAbility : UObject {
	...
	public virtual FGameplayEffectContextHandle GetContextFromOwner(FGameplayAbilityTargetDataHandle OptionalTargetData) { return default; }
	...
	public virtual void SetShouldBlockOtherAbilities(bool bShouldBlockAbilities) {}
	...
	public virtual void SetCanBeCanceled(bool bCanBeCanceled) {}
	...
	public virtual bool K2_CommitAbility() { return default; }
	...
	public virtual bool K2_CommitAbilityCooldown(bool BroadcastCommitEvent/*=false*/,bool ForceCooldown/*=false*/) { return default; }
	...
	public virtual bool K2_CommitAbilityCost(bool BroadcastCommitEvent/*=false*/) { return default; }
	///<summary>Checks the ability&#39;s cooldown, but does not apply it.</summary>
	public virtual bool K2_CheckAbilityCooldown() { return default; }
	///<summary>Checks the ability&#39;s cost, but does not apply it.</summary>
	public virtual bool K2_CheckAbilityCost() { return default; }
	...
	public virtual void RemoveGrantedByEffect() {}
	...
	public virtual void SendGameplayEvent(FGameplayTag EventTag,FGameplayEventData Payload) {}
	///<summary>Returns true if this ability can be activated right now. Has no side effects</summary>
	...
	public virtual void K2_ExecuteGameplayCue(FGameplayTag GameplayCueTag,FGameplayEffectContextHandle Context) {}
	///<summary>Invoke a gameplay cue on the ability owner, with extra parameters</summary>
	public virtual void K2_ExecuteGameplayCueWithParams(FGameplayTag GameplayCueTag,FGameplayCueParameters GameplayCueParameters) {}
	///<summary>Adds a persistent gameplay cue to the ability owner. Optionally will remove if ability ends</summary>
	public virtual void K2_AddGameplayCue(FGameplayTag GameplayCueTag,FGameplayEffectContextHandle Context,bool bRemoveOnAbilityEnd/*=true*/) {}
	///<summary>Adds a persistent gameplay cue to the ability owner. Optionally will remove if ability ends</summary>
	public virtual void K2_AddGameplayCueWithParams(FGameplayTag GameplayCueTag,FGameplayCueParameters GameplayCueParameter,bool bRemoveOnAbilityEnd/*=true*/) {}
	///<summary>Removes a persistent gameplay cue from the ability owner</summary>
	public virtual void K2_RemoveGameplayCue(FGameplayTag GameplayCueTag) {}
