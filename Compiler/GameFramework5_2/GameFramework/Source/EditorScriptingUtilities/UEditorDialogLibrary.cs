...
public partial class UEditorDialogLibrary : UBlueprintFunctionLibrary {
	...
	public static EAppReturnType ShowMessage(FText Title,FText Message,EAppMsgType MessageType,EAppReturnType DefaultValue/*=EAppReturnType.Type.No*/) { return default; }
