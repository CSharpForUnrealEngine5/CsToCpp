...
// PhysicsControlComponent
	public string CreateControl(UObject ParentMeshComponent,string ParentBoneName,UObject ChildMeshComponent,string ChildBoneName,FPhysicsControlData ControlData,FPhysicsControlTarget ControlTarget,FPhysicsControlSettings ControlSettings,string Set,bool bEnabled/*=true*/) { return default; }
	public bool CreateNamedControl(string Name,UObject ParentMeshComponent,string ParentBoneName,UObject ChildMeshComponent,string ChildBoneName,FPhysicsControlData ControlData,FPhysicsControlTarget ControlTarget,FPhysicsControlSettings ControlSettings,string Set,bool bEnabled/*=true*/) { return default; }
	public TArray<string> CreateControlsFromSkeletalMeshBelow(UObject SkeletalMeshComponent,string BoneName,bool bIncludeSelf,EPhysicsControlType ControlType,FPhysicsControlData ControlData,FPhysicsControlSettings ControlSettings,string Set,bool bEnabled/*=true*/) { return default; }
	public TArray<string> CreateControlsFromSkeletalMeshAndConstraintProfileBelow(UObject SkeletalMeshComponent,string BoneName,bool bIncludeSelf,string ConstraintProfile,string Set,bool bEnabled/*=true*/) { return default; }
	public TArray<string> CreateControlsFromSkeletalMesh(UObject SkeletalMeshComponent,TArray<string> BoneNames,EPhysicsControlType ControlType,FPhysicsControlData ControlData,FPhysicsControlSettings ControlSettings,string Set,bool bEnabled/*=true*/) { return default; }
	public TArray<string> CreateControlsFromSkeletalMeshAndConstraintProfile(UObject SkeletalMeshComponent,TArray<string> BoneNames,string ConstraintProfile,string Set,bool bEnabled/*=true*/) { return default; }
	public TMap<string,FPhysicsControlLimbBones> GetLimbBonesFromSkeletalMesh(UObject SkeletalMeshComponent,TArray<FPhysicsControlLimbSetupData> LimbSetupData) { return default; }
	...
	public string CreateBodyModifier(UObject MeshComponent,string BoneName,string Set,EPhysicsMovementType MovementType/*=EPhysicsMovementType.Simulated*/,ECollisionEnabled CollisionType/*=ECollisionEnabled.QueryAndPhysics*/,float GravityMultiplier/*=1.0f*/,bool bUseSkeletalAnimation/*=true*/) { return default; }
	public bool CreateNamedBodyModifier(string Name,UObject MeshComponent,string BoneName,string Set,EPhysicsMovementType MovementType/*=EPhysicsMovementType.Simulated*/,ECollisionEnabled CollisionType/*=ECollisionEnabled.QueryAndPhysics*/,float GravityMultiplier/*=1.0f*/,bool bUseSkeletalAnimation/*=true*/) { return default; }
	public TArray<string> CreateBodyModifiersFromSkeletalMeshBelow(UObject SkeletalMeshComponent,string BoneName,bool bIncludeSelf,string Set,EPhysicsMovementType MovementType/*=EPhysicsMovementType.Simulated*/,ECollisionEnabled CollisionType/*=ECollisionEnabled.QueryAndPhysics*/,float GravityMultiplier/*=1.0f*/,bool bUseSkeletalAnimation/*=true*/) { return default; }
