...
// HUD
	...
	public void AddDebugText(string DebugText,UObject SrcActor,float Duration,FVector Offset,FVector DesiredOffset,FColor TextColor,bool bSkipOverwriteCheck,bool bAbsoluteLocation,bool bKeepAttachedToActor,UObject InFont,float FontScale,bool bDrawShadow) {}
	...
	public void GetTextSize(string Text,float OutWidth,float OutHeight,UObject Font/*=NULL*/,float Scale/*=1.0f*/) {}
	public void DrawText(string Text,FLinearColor TextColor,float ScreenX,float ScreenY,UObject Font/*=NULL*/,float Scale/*=1.0f*/,bool bScalePosition/*=false*/) {}
	...
	public void DrawTextureSimple(UObject Texture,float ScreenX,float ScreenY,float Scale/*=1.0f*/,bool bScalePosition/*=false*/) {}
	public void DrawMaterial(UObject Material,float ScreenX,float ScreenY,float ScreenW,float ScreenH,float MaterialU,float MaterialV,float MaterialUWidth,float MaterialVHeight,float Scale/*=1.0f*/,bool bScalePosition/*=false*/,float Rotation/*=0.0f*/,FVector2D RotPivot/*=FVector2D.ZeroVector*/) {}
	public void DrawMaterialSimple(UObject Material,float ScreenX,float ScreenY,float ScreenW,float ScreenH,float Scale/*=1.0f*/,bool bScalePosition/*=false*/) {}
	public void DrawMaterialTriangle(UObject Material,FVector2D V0_Pos,FVector2D V1_Pos,FVector2D V2_Pos,FVector2D V0_UV,FVector2D V1_UV,FVector2D V2_UV,FLinearColor V0_Color/*=FLinearColor.White*/,FLinearColor V1_Color/*=FLinearColor.White*/,FLinearColor V2_Color/*=FLinearColor.White*/) {}
	...
	public UObject GetOwningPawn() { return default; }
