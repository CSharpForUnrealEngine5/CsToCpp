...
public partial class UMovementComponent : UActorComponent {
	...
	public virtual float GetGravityZ() { return default; }
	///<summary>Returns maximum speed of component in current movement mode.</summary>
	public virtual float GetMaxSpeed() { return default; }
	...
	public virtual bool IsExceedingMaxSpeed(float MaxSpeed) { return default; }
	...
	public virtual APhysicsVolume GetPhysicsVolume() { return default; }
	...
	public virtual FVector ConstrainDirectionToPlane(FVector Direction) { return default; }
	///<summary>Constrain a position vector to the plane constraint, if enabled.</summary>
	public virtual FVector ConstrainLocationToPlane(FVector Location) { return default; }
	///<summary>Constrain a normal vector (of unit length) to the plane constraint, if enabled.</summary>
	public virtual FVector ConstrainNormalToPlane(FVector Normal) { return default; }
