...
public partial class UMeshComponent : UPrimitiveComponent {
	...
	public virtual int GetMaterialIndex(string MaterialSlotName) { return default; }
	///<summary>GetMaterialSlotNames</summary>
	public virtual TArray<string> GetMaterialSlotNames() { return default; }
	///<summary>IsMaterialSlotNameValid</summary>
	public virtual bool IsMaterialSlotNameValid(string MaterialSlotName) { return default; }
