...
public partial class UMaterial : UMaterialInterface {
	...
	///<summary>Cached connected inputs</summary>
	...
	///<summary>Indicates that the material should be rendered as a thin surface (i.e., without inner volume). Only used by Substrate materials.</summary>
