...
public partial class UPhysicalAnimationComponent : UActorComponent {
	...
	public void ApplyPhysicalAnimationSettings(FName BodyName,FPhysicalAnimationData PhysicalAnimationData) {}
	///<summary>Applies the physical animation settings to the body given and all bodies below.</summary>
	public void ApplyPhysicalAnimationSettingsBelow(FName BodyName,FPhysicalAnimationData PhysicalAnimationData,bool bIncludeSelf/*=true*/) {}
	...
	public void ApplyPhysicalAnimationProfileBelow(FName BodyName,FName ProfileName,bool bIncludeSelf/*=true*/,bool bClearNotFound/*=false*/) {}
	...
	public FTransform GetBodyTargetTransform(FName BodyName) { return default; }
