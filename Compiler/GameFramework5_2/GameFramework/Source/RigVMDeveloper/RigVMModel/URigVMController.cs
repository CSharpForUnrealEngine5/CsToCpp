...
public partial class URigVMController : UObject {
	...
	public URigVMRerouteNode AddFreeRerouteNode(bool bShowAsFullNode,string InCPPType,FName InCPPTypeObjectPath,bool bIsConstant,FName InCustomWidgetName,string InDefaultValue,FVector2D InPosition/*=FVector2D.ZeroVector*/,string InNodeName/*=TEXT("")*/,bool bSetupUndoRedo/*=true*/) { return default; }
	...
	public string ExportNodesToText(TArray<FName> InNodeNames) { return default; }
	...
	public bool RemoveNodeByName(FName InNodeName,bool bSetupUndoRedo/*=true*/,bool bRecursive/*=false*/,bool bPrintPythonCommand/*=false*/,bool bRelinkPins/*=false*/) { return default; }
	...
	public bool SetRerouteCompactnessByName(FName InNodeName,bool bShowAsFullNode,bool bSetupUndoRedo/*=true*/) { return default; }
